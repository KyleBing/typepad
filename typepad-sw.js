...
self.addEventListener('install', event => {
   ...
   event.waitUntil(
      caches.open(preFix + version).then(cache => {
         return cache.addAll([
            '/tools/typepad/',
            '/tools/typepad/index.html?v=2.57',
            '/tools/typepad/scss/typepad.css?v=2.57',
            ...
            '/tools/typepad/js/class/Database.js?v=2.57',
            '/tools/typepad/js/class/Utility.js?v=2.57',
            '/tools/typepad/js/class/KeyCount.js?v=2.57',
            '/tools/typepad/js/class/Config.js?v=2.57',
            '/tools/typepad/js/class/Editor.js?v=2.57',
            '/tools/typepad/js/class/Article.js?v=2.57',
            '/tools/typepad/js/class/ArticleType.js?v=2.57',
            '/tools/typepad/js/class/Reg.js?v=2.57',
            '/tools/typepad/js/class/Engine.js?v=2.57',
            '/tools/typepad/js/class/Record.js?v=2.57',
            '/tools/typepad/js/class/CETWord.js?v=2.57',
            '/tools/typepad/js/require_v2.3.6.js',
            '/tools/typepad/js/typepad.js?v=2.57',
