...
cancel\tv.  取消， 废除； 抵消； 删去， 划掉
prepare\tv.  准备， 预备
half\tadv.  一半 adj. 一半的，半个的 n. 半，一半
fifty\tnum.  五十
England\tn.  英格兰， 英国
hall\tn.  门厅； 礼堂， 会堂； 办公大楼
your\tpron.  你的， 你们的
pollution\tn.  污染
pretend\tv.  假装， 佯作
without\tprep.  无， 没有
...
tea\tn.  茶； 茶点
postman\tn.  邮递员
pick\tv. 挑选，选择；采摘 n.  挑选； 选中的人
rabbit\tn.  兔子
ten\tnum.  十， 十个
prison\tn.  监狱
sister\tn.  姐， 妹
energy\tn.  干劲， 精力； 能量； 能源
mystery\tn.  秘密， 神秘的事物
solid\tadj. 固体的；实心的；结实的，稳固的；可靠的；纯质的，纯色的 n.  固体
require\tv.  需要； 要求， 命令； 规定
yourselves\tpron.  你们自己； 你们亲自
lion\tn.  狮子
size\tv.  按大小排列 n. 大小，尺寸，尺码；规模
left\tadv. 在左边，向左 adj. 左边的，左侧的 n.  左边， 左侧； 左派， 左翼
eleven\tnum.  十一
wine\tn.  酒
object\tv.  反对， 不赞成； 反对， 不赞成
newspaper\tn.  报纸
flight\tn.  航班， 班机； 飞行， 飞翔
eraser\tn.  橡皮
hang\tv.  [hung-hung] 悬挂， 吊； 徘徊； [hanged-hanged] 吊
role\tn.  作用； 职责； 角色； 任务
achieve\tv.  实现， 完成； 获得， 达到
anybody\tpron.  任何人； 随便哪一个人
yellow\tadj. 黄的 n.  黄色
I\tpron.  我
turn\tv.  转动， 旋转； 扭转， 转向； 变化， 变成
example\tn.  例子， 实例； 榜样， 楷模
result\tn.  结果； 效果； 成绩， 成果
same\tpron.  同样的人 adj. 同一的；相同的，同样的
after\tadv&prep&conj.  在…以后， 在…后面
quiet\tadj.  轻声的， 安静的， 沉默的； 平静的， 寂静的；
connect\tv.  连接， 衔接； 联合， 关联； 接通电话
hand\tv.  交， 给 n. 手；指针；帮助，援助；手艺，技能
...
police\tn.  警方， 警察； 治安
blue\tadj. 蓝色的；沮丧的，忧郁的；下流的，色情的 n.  蓝色
throw\tv.  [threw-thrown] 投， 扔， 抛； 使突然陷入； 使困惑， 使吃惊
thank\tv. 感谢，向…表示谢意
fifth\tnum. 第五 n.  五分之一
information\tn.  信息， 资料； 通知， 告知
yours\tpron.  你的
discuss\tv.  谈论， 讨论， 论述
standard\tadj.  标准的 n. 标准，规则
correct\tadj. 正确的，对的；合适的，符合的 v.  改正， 纠正； 校准
nobody\tpron. 没有人，无人 n.  无足轻重的人
empty\tadj. 空的；空闲的；空虚的 v.  空， 倒出
wish\tv.  希望， 想要； 但愿； 祝， 祝愿； 盼望， 企求
tie\tv.  [tying]　拴， 扎， 捆； 把…打结， 系上； 连接， 使有关联； 不分胜负
wise\tadj.  有智慧的， 聪明的； 英明的， 明智的； 博学的， 贤明的
serious\tadj.  严重的， 危急的； 重要的， 重大的； 认真的， 严肃的， 庄重的
laugh\tv. 笑 n.  笑， 笑声
conversation\tn.  交谈， 谈话
area\tn.  面积； 地区， 地方； 领域， 范围
pay\tv. 付钱，支付，交纳 n.  工资， 薪金
check\tv. 检查 n.  检查； 支票
list\tv.  把…编列成表； 列举 n. 表；目录，名单
European\tadj. 欧洲的，欧洲人的 n.  欧洲人
strange\tadj.  奇怪的， 奇异的； 陌生的， 生疏的； 外地的， 异乡的
sand\tv.  用砂纸磨光 n. 沙；
toast\tv.  烘， 烤； 敬酒， 为…干杯 n. 烤面包，吐司；祝酒，祝酒词
frustrate\tv.  使沮丧， 使灰心； 失败
success\tn.  成就， 成功； 成功的事物， 取得成就的人
authority\tn. 权力，管辖权；
creature\tn.  生物， 动物， 人； 创造物， 产物
child\tn. 儿童，小孩
outgoing\tadj.  外出的， 离开的； 即将离职的； 友好的， 好交际的； 外向的
young\tadj. 年轻的，青年的；没有经验的；初期的 n.  青年人
rope\tv.  用绳捆 n. 绳索，线缆
instrument\tn.  乐器； 仪器， 器械
medium\tadj. 中等的；平均的 n.  媒介， 工具； 手段， 方法
pear\tn.  梨
society\tn.  社会； 阶层； 社交界； 社团； 协会
root\tv.  生根， 扎根 n. 根；根本，根源；
treasure\tv.  珍爱， 珍视 n. 财宝，珍品
hard\tadj.  坚硬的， 坚固的； 困难的， 艰苦的； 勤勉的， 刻苦
airline\tn.  航空公司； 航线
lend\tv.  [lent-lent] 把…借给， 出借； 贷
November\tn.  十一月
ticket\tn.  票， 入场券， 车票； 罚款传票； 候选
umbrella\tn.  伞， 雨伞
perform\tv.  做， 履行， 完成； 演出， 表演
name\tn.  名字， 名称； 名声， 名誉
concentrate\tv. 全神贯注，全力以赴；集中，聚集；浓缩 n.  浓缩物， 浓缩液
cheer\tv. 使振奋，使高兴；为…欢呼，为…喝彩 n.  欢呼， 喝彩
room\tn.  房间， 室； 空间， 地方； 余地
better\tadv.  更， 更好地 adj. 更好的；有好转的
with\tpron.  和…一起， 跟， 同； 具有， 带有； 用， 以， 藉； 对…， 关于； 随着
service\tn.  公共设施， 公共事业； 公用机构， 服务机构； 服务， 劳务； 维修， 保养
coffee\tn.  咖啡， 咖啡豆； 咖啡树； 咖啡色
there\tadv.  在那里， 往那里； 在那方面， 在那点上
lady\tn.  女士， 小姐； 举止文雅的女子， 淑女
well\tadv.  好； 妥善地， 有利地； 令人满意地； 完全地； 充分地， 足够地； 很， 相当
suitable\tadj.  适当的， 相配的； 合适的， 适宜的
magazine\tn.  杂志， 期刊
pocket\tv. 把…装入口袋 adj.  袖珍的， 小型的 n. 衣袋，口袋；容器
pioneer\tv.  开拓， 开创 n. 先驱者，倡导者
experiment\tv.  进行试验， 做实验 n. 实验，试验
pen\tn.  钢笔； 圆珠笔； 围栏
hate\tv. 憎恨，不喜欢 n.  厌恶， 憎恨
block\tv. 阻碍；堵塞 n.  大块； 一排房屋； 街区
write\tv.  [wrote-written] 写， 书写， 写字； 写作， 作曲； 写
pet\tadj.  宠爱的， 表示亲昵的 n. 宠物；宠儿
period\tn.  时间， 时期， 时代； 学时， 课时； 句号， 句点
bulb\tn.  植物的球茎； 灯泡
understand\tv.  [understood-understood] 理解， 懂； 了解， 意识到； 认为， 以为
birth\tn.  出生， 分娩； 出身； 起源， 根源
dismiss\tv.  不予考虑， 不接受； 解雇， 开除； 解散， 遣散； 驳回， 不受理
picnic\tv.  [picnicked-picnicked, picnicking] 去野餐 n. 野餐
heaven\tn. 天堂，
alright\tadv.  好， 好吧
...
million\tnum. 百万
even\tadv. 甚至；即使 adj.  平的； 均匀的， 平稳的； 相等的， 均衡的； 偶数的
crazy\tadj.  精神失常的； 疯狂的； 迷恋的， 狂热爱好的
volleyball\tn.  排球
coach\tn.  教练， 指导； 长途公共汽车； 经济
southeast\tadv. 向东南 adj.  东南方的， 东南部的， 来自东南的 n. 东南，东南
champion\tv.  拥护 n. 冠军；拥护者
hundred\tn. 百，一百个；
pink\tadj. 粉红色的，桃红色的 n.  粉红色， 桃红色
wait\tv. 等，等候；服侍，侍候 n.  等待， 等待的时间
woman\tn. 成年女子，妇女
queen\tn.  女王， 王后
save\tv. 救助，搭救，拯救；储蓄；贮存，保存 prep.  除…之外
matter\tv.  要紧， 有关系 n. 事情，情况；物质；麻烦事，毛病
ton\tn.  吨； 大量， 许多
conjunction\tn.  联合； 连词
top\tn.  顶， 顶端； 上部， 上端； 首位， 最高位
too\tadv.  也， 还； 太， 过于； 很， 非常
have\tv.  有； 进行， 从事； 享受， 经受； 使， 让； 必须， 不得不
documentary\tadj. 文件的，文献的 n.  纪录片
toy\tv.  漫不经心地考虑； 摆弄 n. 玩具
product\tn.  产品， 产物； 乘积
famous\tadj.  著名的， 出名的
question\tn.  问题， 议题； 疑问； 询问； 难题， 需讨论(或考
peel\tv. 削…的皮，剥…的壳 n.  皮； 外衣
spirit\tn. 精神；灵魂，幽灵；勇气，气概；
cheap\tadj.  便宜的， 廉价的； 劣质的， 低劣的； 卑鄙的， 低级的
produce\tv.  生产， 制造； 展现， 出示； 上演， 制作 n. 产品；农产品
picture\tn.  画， 图片， 照片； 描绘； 电影； 头脑中的情景， 印象 v
cheat\tv. 欺骗，骗取；作弊 n.  欺骗， 欺骗行为； 骗子
regard\tv.  把…看作， 认为； 考虑； 注视， 打量； 注意； 尊敬， 尊重
rose\tn.  玫瑰， 蔷薇
thousand\tnum. 一千，一千个
tonight\tadv&n.  今晚
capital\tadj.  首要的， 重要的； 死罪的； 大写的 n. 资本，资金；首都，首府；大写字母
con\tn.  反对票， 反对论
almost\tadv.  几乎， 差不多
cow\tn.  母牛； 奶牛
...
raise\tv.  举起， 提高； 增加； 筹集， 征集； 唤起， 引起， 激起； 提出； 养育， 饲养， 种植
west\tadj.  西方的， 西部的， 来自西方 n. 西，西方，西部
spoon\tv.  用匙舀 n. 匙，勺，调羹
quite\tadv.  相当， 颇； 实际上， 真正地； 完全， 十分
lap\tn.  腰以下到膝为止的大腿部； 一圈； 一段旅程
tower\tv.  高于， 优于 n. 塔；高楼
traffic\tv.  交易 n. 流动的车辆或行人，交通；交易
law\tn.  法律， 法规； 法学； 律师行业； 规律， 法则
everyone\tpron.  每人， 人人， 各人
lay\tv.  放置， 放下； 铺， 砌； 下， 产； 设置， 布置； 使处于
plenty\tn.  丰富， 充足， 大量
less\tadv.  更少地， 更小地 adj. 更少的，更小的
tutor\tv.  辅导 n. 导师；家庭教师
girlfriend\tn.  女朋友； 女性朋友
condition\tv.  训练， 使适应； 对…有重要影响 n. 状况，状态；
thirsty\tadj.  口渴的； 渴望的， 渴求的
improve\tv.  改进， 改善
snow\tv.  下雪； 用雪覆盖 n. 雪
try\tv.  试图， 努力； 试验， 试用； 审讯， 审理； 考验， 磨炼
lake\tn.  湖
chicken\tn.  小鸡； 鸡肉
bush\tn.  灌木， 灌木丛
university\tn.  大学
fruit\tn.  水果， 果实； 成果， 结果
cause\tv.  使发生， 引起； 使遭受； 给…带来 n. 原因，理由
wound\tv.  使受伤， 伤害 n. 创伤，伤口
teacher\tn.  教师
twentieth\tnum. 第二十 n.  二十分之一
design\tv.  设计； 预订， 指定； 谋划， 构思 n. 设计，构想；图样，图案；企图，图谋
extra\tadv. 特别地 adj. 额外的；特别的 n.  额外的事物， 另外收费的事物
busy\tadj.  忙的； 专心的； 繁忙的， 热闹的； 正在被占用的
land\tv.  靠岸， 登陆； 降落 n. 陆地，地面；土地，田地；国家，国土
department\tn.  部， 局， 处， 科； 系
floor\tn.  地面， 地板； 楼层； 发言权； (海
exhibition\tn.  展览
burn\tv.  [burnt/burned-burnt/burned] 燃烧， 点燃；
modern\tadj.  现代的， 新式的
lamp\tn.  灯
cry\tv. 哭，哭泣；叫喊，鸣，叫；大声地说 n.  哭； 哭声； 叫喊； 叫声
doctor\tn.  医生； 博士
English\tadj.  英语的； 英国的 n. 英语
obey\tv.  服从， 听从
lamb\tn.  羔羊， 小羊； 羔羊肉
fantastic\tadj.  极好的， 极出色的； 了不起的； 异想天开的， 不实际的； 奇异的， 古怪的
unfamiliar\tadj.  不熟悉的
spoken\tadj.  口头的， 口语的
tidy\tadj. 整洁的，整齐的 v.  整洁， 整齐
wall\tv.  筑墙围住， 用墙隔开 n. 墙，壁，围墙
sport\tv.  炫耀， 卖弄 n. 运动；
walk\tv.  步行， 散步； 陪…走， 护送…走
marry\tv.  娶， 嫁， 和…结婚
concert\tn.  音乐会， 演奏会
pity\tn&v.  同情， 怜悯； 可惜， 遗憾
discussion\tn.  讨论， 谈论
supply\tv.  供给， 供应； 满足， 弥补 n. 供给，供应；存货，必需品
unimportant\tadj.  不重要的， 琐碎的
leg\tn.  腿， 腿部； 腿， 支柱
beautiful\tadj.  美丽的； 完美的； 出色的
recycle\tv.  回收利用， 再应用
let\tv.  [let-let]　允许， 让； 假设； 出租； 排放
state\tv.  陈述， 说明 n. 状态，情况；国家，政府；州
press\tv.  压， 按， 挤； 压榨， 压迫； 催促， 逼迫 n. 报刊，报界，新闻界；出版社；压，按
welcome\tv. 迎接，欢迎〔刚到达的人〕 adj. 〔某人〕受欢迎的 n. 欢迎，迎接 interjection. 欢迎〔用于对刚刚到达的人表示欢迎〕
meeting\tn.  会议， 集会； 会合， 相会； 运动会
want\tv.  想要； 希望； 需要
Africa\tn.  非洲
...
circle\tv.  围着， 圈出； 环绕…移动； 盘旋， 环行 n. 圆，圆圈；圈子，界；阶层
thirty\tnum.  三十， 三十个
cup\tn.  杯子； 杯； 奖杯
...
prize\tadj. 第一流的，了不起的 v.  珍视， n. 奖赏，奖金，奖品；值得追求的东西
two\tnum. 二，两个 n.  两个
chase\tv.  追捕； 追求； 寻求
accident\tn.  意外遭遇， 事故
anyway\tadv.  不管怎么说， 无论如何； 不论以何种方式， 无论从什么角度
pop\tv. 突然[出人意料]地从〔某物〕中出来，蹦出，离开，脱落 n. 流行音乐，流行歌曲
found\tv.  创立， 创办， 创建
excuse\tv.  原谅， 宽恕； 使免除； 为…辩解， 作为开脱…的理由
shout\tv. 呼喊，呼叫 n.  呼喊， 喊叫声
kitchen\tn.  厨房； 炊具
escape\tv. 逃脱，逃走；避免，躲避 n.  逃脱， 逃跑； 逃避
funny\tadj.  有趣的， 可笑的
situation\tn.  形势， 局面， 处境； 环境， 状况； 位置， 地点， 场所； 职位， 职务
latest\tadj.  最近的
think\tv. 想，认为，以为
receive\tv.  收到， 接到； 受到， 遭到； 接待； 接见； 欢迎
team\tv.  合作；　结成一队 n. 队，组
tragedy\tn.  惨事， 灾难； 悲剧
watch\tv. 注视，观看；看守，监视，照看；小心，当心 n.  表； 看管， 监视
speech\tn.  讲话， 演说； 言语， 言论； 说话方式
clap\tn&v.  [clapped-clapped, clapping] 拍手， 鼓掌
purple\tn&adj.  紫色
nice\tadj.  好的； 令人愉快的； 友好的， 好心的； 细致的
Jew\tn.  犹太人； 犹太教徒
thing\tn.  事， 事情， 事件； 物， 东西； 局面， 情况， 事态； 所有物， 用品
fashion\tn.  流行款式， 时兴式样；　时尚，　时兴
medical\tadj.  医学的， 医疗的
friendship\tn.  友谊， 友好
till\tprep&conj.  直到
fridge\tn.  电冰箱
lie\tv.  [lay-lain, lying] 躺， 平放； 位于； 处于(某种状
anymore\tadv.  再， 更， 还； 目前， 现在， 今后
smell\tn. 气味 v. 闻出，闻到，嗅到
unable\tadj.  不能的， 不会的
late\tadj.  迟的， 晚的； 末期的， 晚期的； 最近的， 新近的； 已故的； 以前的
ham\tn.  火腿
school\tn.  学校； 学院， 系； 学业， 上课； 学派， 流派
continue\tv.  继续； 延续； 延伸
avenue\tn.  林荫道； 道路， 大街
hat\tn.  帽子
...
last\tadj.  刚过去的， 紧接前面的； 最后的， 最后剩下的； 最不可能的， 最不合适
wash\tv.  洗， 洗去； 冲， 冲掉； 洗衣， 洗脸
doubt\tv.  怀疑， 不相信 n. 疑惑，怀疑
weight\tn.  重量， 体重； 砝码， 秤砣； 重压， 负担； 重要性， 重大
jacket\tn.  短上衣， 夹克
uncomfortable\tadj.  不舒服的； 不舒适的； 感到不安的， 不自在的
develop\tv.  发展； 开发； 研制； 成长； 患； 详尽阐述， 发挥； 使显影
pro\tn. 〔相对于业余爱好者而言的〕专业人士，职业人员〔尤指职业运动员〕 adj. 职业性的；专业的 prep. 赞成的，支持的
warn\tv.  警告， 告诫； 注意， 通知
warm\tadj.  温暖的， 暖和的； 热情的， 热心的； 暖的
district\tn.  地区， 区域； 管区， 行政区
chalk\tn.  粉笔
page\tn.  页， 张
swim\tv. 游水，游泳 n. 游泳
full\tadj.  满的， 装满的； 完全的， 完整的
memory\tn.  记忆； 回忆； 纪念； 存储
away\tadv. 向远处，离开 adj.  不在的； 离开的
scientist\tn.  科学家
impossible\tadj.  不可能的， 办不到的
effort\tn.  努力， 尝试； 努力的成果， 成就
video\tadj. 录像的 v.  制作…的录像 n. 录像；录像带
house\tv.  供宿， 给…房子住 n. 房屋，住宅；[H-]议院
wave\tv.  挥手示意； 波动， 飘动； 高潮， 高涨 n. 波，波浪；挥动
anything\tpron.  无论什么东西， 随便什么事情； 任何东西， 任何事情
yesterday\tadv&n.  昨天
schoolwork\tn.  学校作业， 课堂作业； 家庭作业
furry\tadj.  毛皮的， 盖着毛皮的
early\tadv.  在开始阶段， 在初期； 提前， 提早 adj. 早期的；提早的，提前的
pain\tv.  使痛苦 n. 痛，疼痛；痛苦，悲痛；
disease\tn.  疾病， 病患； 不健全， 弊端
yes\tadv&n.  是， 是的
center\tv.  集中于 n. 圆心，正中；中心
start\tv.  发动； 创办， 开办； 开始， 着手； 动身， 出发； 吃惊， 惊奇
most\tadv. 最；极其，十分 adj.  最多的， 最大的； 大多数的， 大部分的
yet\tadv. 还，尚，仍然；已经；甚至，更 conj.  然而， 但是
teen\tadj.  青少年的 n. 少年男女，青少年
engineer\tn.  工程师， 机械师
supper\tn.  晚餐
pair\tv.  成对， 配对 n. 一双，一对，一副；一对夫妇，一对情侣
lifestyle\tn.  生活方式
manage\tv.  管理， 控制； 操纵， 应付； 设法做到
short\tadv.  简短地； 突然地， 唐突地 adj. 短的，矮的；简短的；短缺的，不足的
time\tn.  时间， 时刻； 次， 回； 时机， 机会； 倍； 时代， 时期
cabbage\tn.  卷心菜， 洋白菜
national\tadj.  国家的， 全国的； 民族的； 国有的， 国立的
happy\tadj.  快乐的， 愉快的； 幸福的； 令人满意的
...
enter\tv.  进入； 参加， 加入
lonely\tadj.  孤独的， 寂寞的； 荒凉的， 人迹稀少的
hey\tint.   嘿
gallery\tn.  画廊， 美术馆； 楼座； 廊台， 走廊
lesson\tn.  课； 教学单元； 一堂课， 一节课； 教训， 经验
destroy\tv.  破坏， 毁灭
moon\tn.  月球， 月亮； 卫星
creative\tadj.  创造性的， 具有创造力的
provide\tv.  供应， 提供
light\tadj.  光线充足的， 明亮的； 淡 n. 光，光亮；光源，灯；火
passenger\tn.  乘客， 旅客
tiny\tadj.  极小的， 微小的
primary\tadj.  最初的， 最早的； 首要的， 根本的
artist\tn.  艺术家， 画家； 能手
lazy\tadj.  懒惰的， 懒散的； 慢吞吞的
bright\tadj.  明亮的， 光明的； 聪明的， 机灵的； 欢快的； 鲜艳的； 清晰的
alien\tadj. 外国的；外星的；陌生的；格格不入的 n.  外国人； 外星人
smart\tadj. 聪明的，精明的，高明的；漂亮的 n.  剧痛
lot\tn.  许多， 大量； 签， 抽签； 一块地， 场地
tourist\tn.  旅游者， 观光者
low\tadj.  低的， 矮的； 低下的， 低等的； 粗劣的， 低俗的； 不充分的， 缺乏的； 意气
theme\tn.  主题， 题目； 【音】主旋律
wealth\tn.  财富， 财产； 丰富， 大量
wallet\tn.  皮夹子
doll\tn.  玩偶， 玩具娃娃
chair\tv.  担任主席 n. 椅子；主席，主席席位
centre\tv.  集中于 n. 圆心，正中；中心
tennis\tn.  网球
chat\tn&v.  [chatted-chatted, chatting] 闲谈， 聊天
fetch\tv.  拿来； 请来， 叫来
choice\tn.  选择， 选择权； 供选择的东西； 被选中的东西
travel\tv.  旅行； 行进； 被传送， 被传播； 走过， 驶过 n. 旅行，游历
small\tadj.  小的； 少的； 不重要的
door\tn.  门， 出入口； 家， 户
quick\tadv.  快， 迅速地 adj. 快的，迅速的；灵敏的，敏捷的；性急的，不耐烦的
fiction\tn.  小说
before\tconj.  在…以前 prep. 在…以前；在…之前，先于；在…前面，在…面前
dad\tn.  爸爸
sixteenth\tnum. 第十六 n.  十六分之一
tell\tv.  [told-told] 讲， 告诉； 吩咐， 命令； 说明， 显示； 分辨， 区分
stomach\tv.  承受， 忍受； 吃得下 n. 胃，胃口；肚子，腹部
husband\tn.  丈夫
appointment\tn.  约会； 约定； 任命， 委派； 职务， 职位
experience\tv.  经历， 体验， 感受 n. 经历，阅历；经验，体验
him\tpron.  他
listen\tv.  听； 听信
...
bear\tv. 忍受，忍耐，经受住 n. 熊
eighty\tnum.  八十
consider\tv.  考虑， 细想； 认为， 把…看作； 关心， 照顾
day\tn.  天， 一昼夜； 白昼， 白天； 时期， 时代； 工作日；
housework\tn.  家务劳动
banana\tn.  香蕉
island\tn.  岛， 岛屿
tree\tn.  树
...
water\tn. 水，雨水，
August\tn.  八月
square\tadj. 正方形的；平方的；直角的 v.  求平方； 求…的面 n. 正方形；平方；广场
careless\tadj.  粗心的； 草率的； 随便的； 不关心的， 满不在乎的
twice\tadv.  两倍； 两次
soap\tn.  肥皂
morning\tn.  早晨， 上午
part\tn.  一部分， 部分； 零件； 角色； 职责， 作用； 器官，
their\tadj&pron.  他们的
percent\tadj.  百分之… n. 百分比，百分率
thirteen\tnum.  十三， 十三个
point\tn.  要点； 观点； 点； 小数点； 时刻， 地点； 尖， 尖端； 分数， 得分
bike\tn.  自行车
general\tadj. 一般的，普通的；普遍的，全体的；笼统的，大体的 n.  将军； 一般原则
east\tadv.  向东方 adj. 东方的；来自东方的 n. 东，东部
sixteen\tnum.  十六， 十六个
hospital\tn.  医院
park\tv.  停放 n. 公园；停车场
eighth\tnum. 第八 n.  八分之一
clear\tadv. 　清晰地， 清楚地 adj. 清楚的，明白的；无疑的，确信的；晴朗的；清澈的
clean\tadj.  清洁的， 干净的； 爱清洁的； 清白的， 公正的；
meal\tn.  膳食， 一餐， 一顿； 进餐
sock\tv. 重击，痛打
someone\tpron.  有人， 某人
third\tnum. 第三 n.  三分之一
...
meat\tn.  肉
chew\tv.  咀嚼； 咬住， 不停地啃
hurry\tv. 使加快，催促；急运，急派；匆忙，赶紧 n.  急忙， 匆忙， 仓促
schoolbag\tn.  书包
chopsticks\tn.  筷子
path\tn.  小路， 小径； 路线， 途径， 路径
trip\tn. 旅游；旅行，出行 v. 绊；绊倒
casually\tadv.  偶然地； 随便地； 临时地
record\tn.  记录， 记载； 唱片； 最高纪录， 最佳成绩； 记录， 记载； 唱片； 最高纪录， 最佳成绩
railway\tn.  铁道， 铁路
strict\tadj.  严格的， 严厉的； 严谨的， 精确的； 完全的，
modest\tadj.  谦虚的， 谨慎的； 适度的
you\tpron.  你， 你们
jump\tn&v.  跳跃， 跳过； 猛涨， 激增
happen\tv.  发生； 碰巧， 恰好
sofa\tn.  沙发
pass\tv.  经过， 穿过； 传递， 传送； 度过； 通过； 批准
past\tadj. 以前的，过去的；结束了的，不复存在的 prep. 晚于，在…之后 n.  昔日，
festival\tn.  节， 节日， 喜庆日
mile\tn.  英里
shock\tn.  震动， 冲击； 震惊， 惊愕； 电震， 电击， 触电
milk\tv.  挤 n. 牛奶
opportunity\tn.  机会， 良机
bill\tn.  账单； 议案， 法案； 纸币， 钞票； 单子， 节目单； 招贴， 海报
pancake\tn.  薄煎饼， 烙饼
active\tadj.  活跃的； 积极的； 主动的； 起作用的
court\tv.  献殷勤； 追求， 求爱； 招致， 导致 n. 法庭，法院；宫廷，朝廷；球场
easy\tadj.  容易的， 不费力的； 舒适的， 安逸的； 随和的， 友善的
whose\tpron.  谁的； 那个的， 那些的
population\tn.  人口； 某领域的生物； 族群； 人口
route\tn.  路线， 路程
Monday\tn.  星期一
...
mirror\tv.  反映； 反射， 映照 n. 镜子
compare\tn&v.  比较； 比喻
bottle\tn.  瓶子
hot\tadj.  热的； 辣的； 激烈的， 热烈的； 急躁的， 易发怒的； 最新的， 热
how\tadv.  怎么， 怎样； 多么， 多少
October\tn.  十月
hotel\tn.  旅馆， 宾馆
term\tn. 措词，术语；期限，任期；学期；
spare\tadj. 备用的；多余的；空闲的 v.  留出， 抽出； 饶恕， 不伤害； 使免遭，
mine\tpron. 我的 v.  开矿， 采矿 n. 矿，矿山；地雷；水雷
mind\tn.  头脑， 精神， 理智； 智力； 注意力， 心思； 意向， 想法
chip\tv.  削下 n. 碎片；芯片
business\tn.  交易， 生意； 营业； 商业； 工作， 任务； 事务
tail\tv.  附于其后； 尾随， 跟踪 n. 尾巴，尾状物；后部，尾部；踪迹
staff\tv.  为…配备人员， 任职于 n. 全体职工，工作人员；杠，棒；参谋部
possible\tadj.  可能的， 做得到的； 可接受的， 合理的
right\tadj.  正确的； 正当的， 公正的； 右边的； 合适的；　健康的， 正常的； 直的
march\tv. 行军，前进；游行示威 n.  行进， 行军； 游行示威； 进行， 进展； [M-] 三月
meet\tv.  [met-met] 遇见， 碰到； 接； 和…见面， 和…会面
answer\tv.  回答， 答复； 解答， 解决； 作 n. 回答，答复；答案，解决办法
stage\tn.  舞台， 后台； 平台， 高台； 楼层， 楼架
borrow\tv.  借， 借入； 借用， 采用
junk\tv.  丢弃， 废弃 n. 废旧物品，破烂
waiter\tn.  侍者， 服务员
under\tprep.  在…下面， 在…底下； 少于； 低于； 在…管辖下， 在…影响下
purse\tn.  钱包； 女用小包
spotlight\tv.  用聚光灯照； 特别关注； 突出报道 n. 聚光灯；公众的注意
represent\tv.  作为…的代表； 描述； 表示； 象征； 描绘， 表现； 阐明， 说明； 扮演
quarter\tn. 四分之一；季，季度；一刻钟；25分的硬币；
die\tv.  [dying]　死， 死亡； 消失； 停止运行； 渴望； 消
dig\tv. 挖（土等），掘（洞） n. 挖苦，嘲讽
sometimes\tadv.  不时； 有时， 间或
promise\tv. 允诺，答应；有…可能，有希望 n.  承诺， 诺言； 可能性， 希望
down\tadv. 向下，在下面；处于低等地位，处于潦倒状况 adj.  沮丧 prep. 沿着…而下
...
club\tn.  俱乐部， 社团
talk\tv.  说， 讲话； 交谈， 谈论
tall\tadj.  高的， 身材高的； 难以置信的； 难以办成的
reply\tn&v.  回答， 答复， 以…作答
train\tv.  训练； 培养 n. 列车，火车；一连串，一系列；行列
possibly\tadv.  大概， 也许
test\tn&v.  试验， 测试； 检验
planet\tn.  行星
count\tv.  点…的数目， 计算； 把…算入； 认为， 看作； 值得考虑， 有重要意义
brown\tadj. 棕色的，褐色的 n.  棕色， 褐色
take\tv.  [took-taken] 带， 携带； 需要， 花费； 拿， 取得； 接受； 吃， 喝， 服(药
misleading\tadj.  令人误解的， 导致错误结论的； 引入歧途的； 欺骗的； 迷惑人的
final\tadj. 最后的，最终的；决定性的，确定性的 n.  期末考试； 决赛
some\tadv.  大约； 稍微 pron. 一些，若干 adj. 一些，若干，有些；某个，某一
blank\tadj.  空白的， 空着的； 茫然的， 无表情的
rather\tadv.  相当； 有点儿； 宁愿， 宁可； 更确切地说
importance\tn.  重要
back\tadv. 回原处，回原状；向后，后仰着；还；以前；回，往回 n.  背， 背部； 后面，
miss\tv.  未击中， 未达到； 未赶上， 错过； 思念， 想念； 未明白； 避免， 逃脱 n. 小姐
pound\tv.  强烈打击， 猛击； 心怦怦跳； 费力地移动 n. 磅；英镑
company\tn.  公司， 商号； 陪伴， 交往； 同伴， 朋友； 客人； 群， 伙
just\tadv.  正好， 恰恰正是； 只是， 仅仅； 刚才； 确实， 真正地； 非常； 勉强地
human\tadj. 人的；人性的；有人情味的，有人性的 n.  人
notice\tv. 注意到，察觉到 n.  注意， 察觉； 通知， 布告
owner\tn.  物主， 所有人
hometown\tadj.  家乡的 n. 家乡
relax\tv.  放松， 松弛； 放宽， 缓和
custom\tn. 习惯，风俗；惯例；
permission\tn.  许可， 允许
home\tadj.  家庭的； 家用的； 国内的 n. 家乡；家，家庭；原产地，发源地
hole\tn.  洞， 孔眼； 漏洞， 缺陷
print\tv.  印刷， 出版； 用印刷体写； 冲洗
material\tadj.  物质的， 实际的； 客观存在的； 重要的 n. 材料，原料；素材；布料
although\tconj.  虽然， 尽管； 然而
beach\tn.  海滩， 沙滩
baby\tn.  婴儿
iron\tv.  熨， 烫 n. 铁；烙铁，熨斗
adverb\tn.  副词
president\tn.  总统； 主席； 校长， 会长； 董事长， 总经理
explain\tv.  讲解， 说明
...
thick\tadj.  厚的， 粗的； 笨的， 迟钝的； 稠的， 浓的； 密的， 密集的
soon\tadv.  不久， 即刻； 早， 快
December\tn.  十二月
tape\tv.  系， 捆； 把…录在磁带上 n. 带子；磁带；录像带
balance\tv.  使平衡， 使均衡； 称； 权衡 n. 天平，称；均衡，平衡；结存，结欠
lock\tv. 锁上；卡住 n.  锁； 船闸
fear\tn.  害怕， 恐惧； 恐惧的原因； 令人恐惧的事物
song\tn.  歌， 歌曲； 鸣声， 歌声
cookie\tn.  饼干
belt\tn.  地带， 地区； 腰带， 皮带
chop\tv. 切，劈，砍 n. 〔羊、猪等〕排骨
cream\tadj.  奶油色的 n. 奶油；护肤霜；奶油色
sense\tv.  觉得， 意识到 n. 感官，官能；感觉；判断力，见识
bell\tn.  钟， 铃； 钟声， 铃声
heavy\tadj.  重的， 重型的； 大量的， 密集的； 严重的， 严厉的； 剧烈的， 繁重的； 沉重
Canada\tn.  加拿大
afford\tv.  买得起， 负担得起； 提供， 给予
field\tn.  田地， 田野； 场地；　领域， 界，　学科
underground\tadj. 地下的；秘密的，不公开的 n.  〈英〉地铁
baseball\tn.  棒球
dog\tn.  狗； 犬科动物
...
stamp\tn.  邮票， 印花； 印， 图章； 标志， 印记； 跺脚， 顿足
summer\tn.  夏天， 夏季
eight\tnum.  八
mention\tn&v.  提及， 说起
mad\tadj.  疯的， 神经错乱的； 恼火的， 狂怒的； 狂热的， 着迷的
barbecue\tv.  在烤架上烧烤 n. 烧烤野餐；金属烤架
next\tadv.  接下去， 然后； 居后地， 次于 adj. 下一个的；紧接在后的；接下来的
stream\tv.  流， 涌 n. 小河，溪流；流，一股；一连串
member\tn.  成员， 会员
nurse\tv.  护理， 照料 n. 护士；保姆，保育员
...
map\tv.  在地图上标示出； 绘制…的地图 n. 地图，图
together\tadv.  在一起， 共同； 一致地， 协调地
illness\tn.  病， 疾病
twenty\tnum.  二十， 二十个
cigarette\tn.  香烟
may\tmodal verb. 可能，也许 n. 山楂花
forward\tadv. 向前；向将来，从今往后 adj.  前部的， 位于前面的
could\tmodal verb. 能，会，可以〔can 的过去式〕
health\tn.  健康； 卫生， 保健
positive\tadj.  积极的， 正面的； 肯定的； 【电】正的， 阳性的； 确实的， 明确的； 十足的，
menu\tn.  菜单
machine\tn.  机器， 机械
able\tadj.  能够…的， 得以…的； 有才干的， 能力出
evening\tn.  傍晚， 晚上
mend\tv.  修理， 修补； 改良， 改进； 修正， 改正； 恢复健康， 痊愈
return\tv. 返回，回来；回复，回应；退回；回报 n.  返回， 回来； 偿还， 归还； 恢复； 回
instance\tn.  例子， 实例， 事例； 情况
opera\tn.  歌剧
mail\tv.  邮寄 n. 邮政，邮递；邮件，邮包；电子邮件
use\tv. 用，使用；耗费，消费 n.  使用， 应用； 用途， 效用
feel\tv. 感受到，觉得，体会到 n. 感觉
thrill\tn.  兴奋， 激动； 引起激动的事物； 震动， 颤抖
main\tadj.  主要的； 最重要的
serve\tv.  为…服务； 任； 招待， 接待， 伺候； 符合， 适用于， 满足； 供应；
cough\tn&v.  咳， 咳嗽
smile\tv.  微笑， 露出笑容； 笑， 用微笑表示 n. 微笑，笑容
radio\tv.  用无线电传送 n. 无线电广播；设备；收音机
solution\tn.  解决， 解答， 解决办法； 溶液
fine\tadj.  健康的， 舒适的； 极好的， 优秀的； 纤细的， 细小的； 精制的， 高质量的；
find\tv. 发现，找到 〔一直在寻找之物〕 n. 〔尤指通过挖掘或水下打捞找到的〕发现物
host\tn.  主人； 东道主； 节目主持人； 许多， 大量
international\tadj.  国际的， 世界的
terrible\tadj.  极度的， 厉害的； 可怕的， 骇人的； 很糟的， 极坏的
combine\tv. 联合，结合 n.  联合企业； 联合收割机
waste\tv.  浪费， 未充分利用 n. 浪费，糟蹋；废料，废弃物
turtle\tn.  海龟
comedy\tn.  喜剧， 喜剧性
pleasant\tadj.  舒适的； 令人愉快的； 讨人喜欢的
equipment\tn.  装备， 配备
difficult\tadj.  困难的； 难懂的； 难以取悦的
dry\tadj. 干的，干旱的；口渴的 v.  使干， 使脱水
film\tv.  拍摄电影 n. 影片，电影；胶片，胶卷；薄层，薄膜
sort\tv.  分类， 整理 n. 种类，类别；某一种人，某一类人
pressure\tv.  对…施加压力； 迫使， 说服 n. 压；压强；强制，压迫
fill\tv. 装满；　使充满；满足 n.  填满…的量；　吃饱的量
heart\tn.  心， 心脏； 内心， 感情； 勇气， 热忱； 中心， 要点
dentist\tn.  牙科医生
...
true\tadj.  真实的， 确实的； 真正的， 真的； 忠诚的， 忠实的； 准确的， 精确的
position\tv.  安放， 安置 n. 位置，方位；职位，职务；姿势，姿态；立场
neck\tn.  颈， 脖子； 领圈， 领口
since\tadv.  后来， conj. 自…以来，从…以后；因为，既然 prep. 自…以来，从…以后
handsome\tadj.  漂亮的， 英俊的； 端庄健美的， 好看的； 慷慨的， 可观的
soup\tn.  汤
stair\tn. 梯级
belong\tv.  属于， 应归入
...
sour\tadj.  酸的， 酸味的； 馊的， 酸臭的； 乖戾的， 尖酸刻薄的； 发酸的； 酸痛的
native\tadj. 出生地的；当地的 n.  土生土长者， 本国人
breath\tn.  气息， 呼吸的空气， 呼吸； 微风， 轻微流动
ball\tn.  球， 球状物； 舞会
hour\tn. 小时，钟点；时间，时刻；
repeat\tn&v.  重复； 重说； 重做
nervous\tadj.  神经紧张的， 情绪不安的； 神经系统的； 神经性的
make\tv.  [made-made] 做， 制造； 作出， 制定； 使， 迫使； 获得， 挣得； 成为， 到达
microwave\tn.  微波； 微波炉
structure\tv.  构造， 建造 n. 结构，构造；建筑物
master\tv. 掌握，精通；征服 adj.  主要的， 最重 n. 主人，雇主；能手；名家，大师
outdoor\tadv.  在户外， 在野外 adj. 户外的，野外的
orange\tadj.  橙色的 n. 橙，柑，橘；橙汁，橘汁
online\tadj.  在线的； 联机的， 联网的
writer\tn.  作者， 作家
fence\tv.  围住，　隔开； 回避，　搪塞 n. 栅栏，篱笆
depend\tv.  依靠， 依赖； 信赖， 相信； 取决于， 视…而定
about\tprep.  关于， 对于； 在…周围， 在…各处
weekday\tn.  平常日， 工作日
danger\tn.  危险； 危险事物； 威胁
theatre\tn.  戏院， 剧场； 影剧院
cover\tv. 盖，覆盖；范围为，占；行，行过；包括；报道；掩护 n.  盖子； 套子；
firm\tadj.  坚实的， 结实的； 稳固的； 坚定的， 坚决的 n. 公司，商行
bank\tv.  把存入银行 n. 银行；库；岸，堤
character\tn.  性格； 特色， 特性； 人物， 角色； 符号， 字
meaning\tn.  意思， 含义； 意义
above\tadv.  在上面， 在顶上； (在级别、 权力、 数目 prep. 在…上方；多于，超过
fire\tv.  放， 射出； 解 n. 火，炉火；火灾，失火；射击，火力
...
taxi\tn.  出租车
wonderful\tadj.  极好的； 惊人的， 奇妙的
tiger\tn.  虎
something\tpron. 某物，某事 n.  重要的事物， 有一定意义的事物
quality\tadj.  优良的， 优质的 n. 质，质量；品德，品质；性质，特性
labor\tn.  劳动； 工作
rude\tadj.  粗鲁的， 无礼的； 粗糙的， 粗陋的； 猛烈的
animal\tadj.  动物的， 野兽的 n. 动物，兽，牲畜
except\tv.  将…除外， 不包括 prep. 除…外
shower\tv.  洗淋浴； 洒落； 纷纷降落 n. 淋浴；阵雨，暴雨
fact\tn.  事实， 真相
examine\tv.  检查； 调查； 考试， 测验
association\tn.  协会， 联盟， 社团； 联合， 结合
industry\tn.  工业， 产业； 勤劳， 勤奋
believe\tv.  相信； 认为
cute\tadj.  漂亮的， 娇小可爱的； 聪明的， 伶俐的
long\tadv.  长期地 adj. 长的；长期的 v. 渴望，热望
remember\tv.  记得， 记住； 缅怀； 代…问候
into\tprep.  进， 到…里； 关于， 有关
unless\tconj.  除非， 如果不
temperature\tn.  温度； 体温； 热度， 发烧
free\tadj.  自由的， 无约束的； 免费的， 无偿的； 空闲的， 未被占用的； 无…的， 摆
mix\tv. 使混合，配制；相混，搞混 n.  混合， 搅和
dirty\tadj.  肮脏的； 下流的， 黄色的； 卑鄙的， 不道德的； 暴风雨的， 恶劣的
natural\tadj.  自然的， 正常的； 出于本性的， 天赋的； 自然界的， 天然的
middle\tadj.  中部的， 中间的 n. 中部，中间
bother\tv. 打扰，麻烦；使不安，迷惑 n.  麻烦， 焦急； 令人烦恼的人
though\tadv.  可是， 不过， 然而 conj. 尽管，虽然
star\tn.  星； 星形； 明星， 名角
wolf\tn.  狼； 残忍贪婪之人
many\tpron.  许多人， 许多 adj. 许多的，多的
people\tn.  人， 人们； 人民， 民众， 平民； 国民； 民族
transportation\tn.  运输， 运输系统； 运输工具
everyday\tadj.  每天的； 日常的
stay\tv. 逗留，暂住；保持，继续是；停止，延缓 n.  逗留， 停留
diary\tn.  日记簿， 日记
appear\tv.  出现， 显露， 来到； 看起来好像， 似乎； 产生， 问世； 发表
face\tv.  面向， 正对； 面对， 面临 n. 脸，面孔；面部表情；面，表面
fish\tv.  钓， 捕 n. 鱼
afraid\tadj.  害怕的， 恐惧的； 犯愁的
progress\tv.  前进， 行进； 前进， 行进
invite\tv.  邀请； 征求， 请求； 吸引， 招致
Australia\tn.  澳大利亚
operation\tn.  操作， 运转， 经营； 手术； 行动， 活动； 运算
open\tadj.  开着的； 公开的； 坦率的； 开阔的； 开始营业的； 空缺
agent\tn.  代理人， 代理商， 经纪人
treat\tv. 对待，处理；治疗，医治；款待，招待 n.  款待， 招待
movie\tn.  电影， 影片； 电影院， 电影业
rapid\tadj.  迅速的， 快的
seven\tnum.  七， 七个
project\tv.  投射， 发射； 放映； 凸出， 伸出； 设计， 规划； 投射， 发射； 放映； 凸出， 伸出； 设计， 规划
ice\tv. 使变凉，冰冻，冰镇 adj.  冰的 n. 冰，冰块
inside\tadv. 在里面，在内部 adj.  里面的， 内 prep. 在…里面，在…内部 n. 里面，内侧
whenever\tconj.  无论何时， 随时； 每当
wood\tn.  木材， 木头， 木料； 树林， 林地
five\tnum.  五
surprise\tn.  惊奇， 诧异； 令人惊奇的事物
suitcase\tn.  手提箱， 衣箱
beard\tn.  胡须
celebrate\tv.  庆祝， 欢庆； 赞扬， 歌颂
please\tv.  使愉快， 使高兴； 使满意， 合…的心意 int. 请
look\tv.  看， 注视； 显得， 看上去； 朝着， 面向
hunger\tv.  渴望， 渴望得到 n. 饿，饥饿；食欲，胃口；渴望
laboratory\tn.  实验室， 研究室
allow\tv.  允许， 准许， 容许； 允许…进入； 同意给； 承认
knock\tn&v.  敲， 打； 碰撞， 撞击
father\tn.  父亲； 祖先， 先辈； 创始人， 奠基人
rule\tn.  规则， 规章； 习惯， 惯例， 惯常的事； 统治， 管辖
proper\tadj.  正确的， 适当的； 合乎体统的， 正当的； 固有的， 特有的
vegetable\tadj.  蔬菜的； 植物的 n. 蔬菜；植物
speed\tn.  速度； 迅速， 快
Russia\tn.  俄国， 俄罗斯
apple\tn.  苹果， 苹果树
poem\tn.  诗
common\tadj.  共同的； 平常的， 普通的； 共有的， 公有的
interest\tv.  使感兴趣； 引起…关注 n. 兴趣，爱好；利息，利率；利益，好处；利害关系
China\tn.  中国
themselves\tpron.  他们自己； 他们亲自
wonder\tv.  对…感到疑惑， 想知道； 感到惊讶
music\tn.  音乐， 乐曲
every\tadj.  每一， 每个； 每…一次的； 所有可能的
twin\tadj.  孪生的， 成双的 n. 孪生儿之一，双胞胎之一
again\tadv.  再一次， 又一次； 回到原处， 复原； 再则， 而且
step\tn.  步， 脚步； 步骤， 措施； 台阶， 梯级
comment\tv.  评论 n. 评论，意见；闲话，议论
mark\tn.  痕迹， 斑点， 污点； 记号， 标记； 分数
whole\tadj. 全部的，全体的；完整的，无缺的 n.  全部， 整体
fair\tadv.  公正地， adj. 公平的，公正的；尚可的，不错的；浅色的，白皙的；晴朗的
during\tprep.  在…期间
relation\tn.  关系， 关联； 亲属， 亲戚
money\tn.  钱， 货币
elevator\tn.  电梯； 升降机
safety\tn.  安全， 保险； 安全设备， 保险装置； 安全场所
lost\tadj.  失去的， 丧失的； 错过的； 迷惑的
price\tv.  给…定价 n. 价格，价钱；代价
calculator\tn.  计算器
still\tadv.  依然， 还， 仍旧； 然而， 尽管如此； 甚至更， 还要； 静止地
biology\tn.  生物学
work\tv.  工作， 劳动； 运转； 起作用， 有效； 生产， 经营
lose\tv.  [lost-lost] 失去， 损失； 迷失， 使迷路； 输， 输掉； 白费， 浪费； 走慢
agree\tv.  同意， 赞同； 相符， 一致
fail\tv.  失败； 不及格； 衰退
itself\tpron.  它自己， 它本身； 自身， 本身
toward\tprep.  向， 朝， 面对； 接近
among\tprep.  在…之中， 在…之间
anyone\tpron.  任何人； 随便哪一个人
pride\tn.  自豪， 骄傲； 引以为傲的人或物； 自尊， 自尊心； 自负； 傲慢
math\tn.  数学
monkey\tn.  猴子
breakfast\tn.  早餐
word\tn.  词， 单词； 言语， 话； 消息， 传说； 诺言， 保证
favorite\tadj.  特别喜爱的 n. 特别喜欢的人或事物
love\tv. 爱，热爱；喜欢，爱好 n.  爱， 喜爱
church\tn.  教堂； 礼拜； 教会
enjoy\tv.  享受； 喜爱； 享有
secret\tadj. 秘密的，机密的 n.  秘密
ourselves\tpron.  我们自己； 我们亲自
foreign\tadj.  外国的， 外国产的； 对外的， 涉外的； 外来的
uniform\tadj.  相同的， 一致的 n. 制服
across\tprep.  穿过， 越过， 横过； 在…对面； 遍及
fall\tv.  [fell-fallen] 落下， 降落； 跌倒， 塌倒； 降临， 来临； 失势， 垮台； 下垂， 倾
ear\tn.  耳， 耳朵； 听力， 听觉
indoors\tadv.  在屋内， 在室内
eat\tv.  [ate-eaten] 吃， 吃饭
finger\tn.  手指
loud\tadj.  响亮的， 大声的； 刺目的； 太招摇的
include\tv.  包括， 包含， 计入
homework\tn.  家庭作业， 课后作业
juice\tn.  汁， 液
opinion\tn.  意见， 主张
comma\tn.  逗号
soldier\tn.  士兵， 军人
culture\tn.  文化； 文明； 教养， 教育
first\tadv.  先， 在首位； 第一次， 首次 adj. 最先的，最早的 num. 第一
voice\tn.  声音， 嗓音； 发言权； 意见； 语态
prefer\tv.  更喜欢， 宁愿
perfect\tadj.  完美的， 无瑕的； 完全的， 十足的； 最佳的， 理想的
space\tn.  空地， 场地； 空间， 太空； 篇幅； 间隔， 距离； 持续时间， 期间
never\tadv.  从不， 永不； 决不， 千万不
basketball\tn.  篮球
frog\tn.  蛙
theater\tn.  戏院， 剧场； 影剧院
mother\tn.  母亲， 妈妈
from\tprep.  从…来， 出自； 离； 去除， 免掉； 从， 据； 因
soft\tadj.  柔软的， 细嫩的， 光滑的； 轻的， 轻柔的； 柔和的；
moment\tn.  片刻， 瞬间， 时刻； 机会， 时机
discover\tv.  发现， 发觉
spell\tn.  咒语， 符咒； 魅力； 连续的一段时间
much\tadv. 十分，非常 pron.  许多， 大量
bottom\tadj.  最低的， 最下的 n. 底，底部；末尾，尽头；臀部
Japan\tn.  日本
ill\tadj.  有病的； 不好的， 坏的； 恶意的， 敌意的
mouse\tn.  鼠； 胆小的人； 鼠标
excite\tv.  使兴奋； 使激动； 引起， 激起
pond\tn.  池塘
repair\tv.  修理， 修补； 弥补， 补救 n. 修理，修补；维修状态，保养情况
death\tn.  死， 死亡； 毁灭
steal\tv.  [stole-stolen] 偷盗， 行窃； 悄悄地移动
advice\tn.  劝告， 忠告， 意见， 建议
scientific\tadj.  科学的， 科学上的
winter\tadj.  冬天的 n. 冬，冬季；萧条期，衰退期
elder\tadj. 年龄较大的，年长的
terrorist\tn.  恐怖主义者
attendant\tadj.  伴随的， 随之而产生的 n. 服务人员，侍者；随从
public\tadj. 公众的；公共的，公用的；公开的 n.  公众， 民众
paper\tn.  纸， 墙纸； 报纸； 文件； 文章， 论文； 书面作业， 试卷
my\tpron.  我的
spend\tv.  [spent-spent] 花费， 用； 花； 度过， 消磨； 消耗， 用尽
zoo\tn.  动物园
February\tn.  二月
value\tv.  给…估价； 评价 n. 价值；价格；购买力；重要性；益处
x-ray\tadj.  X射线的， X光的
advantage\tn.  优点， 好处， 优势
assistant\tadj.  助理的， 辅助的 n. 助手；助教
ink\tn.  墨水； 油墨
instead\tadv.  作为替代， 顶替； 反而， 却
rush\tv. 冲，突进，急速流动；仓促行事；猛冲 n.  冲， 奔， 急速行进； 匆
expensive\tadj.  昂贵的， 花钱多的
trade\tv.  贸易， 交换 n. 贸易，商业；行业，职业
round\tadv. 在周围，在附近；朝反方向 adj. 圆的，球形的 prep.  围绕， 绕过； 向…
dessert\tn.  甜食， 甜点
carrot\tn.  胡萝卜
...
score\tn.  得分， 分数； 乐谱； 抓痕， 划痕； 二十
poor\tadj.  贫困的， 贫穷的； 可怜的； 低劣的， 差的
farm\tv.  耕作 n. 农场；养殖场
absent\tadj.  缺席的， 不在场的； 不存在的； 心不在焉的
because\tconj.  因为
July\tn.  七月
educate\tv.  教育； 培养， 训练
rat\tn.  鼠
excellent\tadj.  优秀的， 卓越的， 杰出的
pool\tn.  池塘， 水池； 游泳池； 一摊， 一片
lighting\tn.  照明； 照明设备； 光线
airport\tn.  机场； 航空港
exam\tn.  考试； 试题； 检查， 调查
stop\tv.  [stopped-stopped, stopping]　停止， 中断； 塞住， 堵塞； 阻止， 阻挠； 逗留， 歇宿
science\tn.  科学； 学科
poster\tn.  招贴， 海报， 广告
hobby\tn.  业余爱好， 嗜好
June\tn.  六月
...
forest\tn.  森林， 林木
throat\tn.  咽喉， 嗓子
least\tadv.  最少， 最小 adj. 最少的，最小的；最不重要的
immediately\tadv.  立即， 马上； 直接地， 紧接着地
pork\tn.  猪肉
symphony\tn.  交响乐， 交响曲； 和谐， 协调
dollar\tn.  美元； 元
sleep\tn&v.  [slept-slept]　睡
hungry\tadj.  饥饿的， 感到饿的； 渴望得到的
French\tn. 法国人；
vocabulary\tn.  词汇； 词汇量； 词汇表
refuse\tv.  拒绝， 不接受， 谢绝
retire\tv.  退休， 退役； 退下， 退出； 退却， 撤退； 就寝
aggressive\tadj.  侵犯的， 侵略的， 挑衅的； 敢作敢为的， 有进取心的
close\tadv. 接近地；接近地 adj. 密切的，亲密的；近的，接近的；严密的，仔细的；不通风的，闷的；密切的，亲密的；近的，接近的；严密的，仔细的；不通风的，闷的 n.  结束， 终止； 结束， 终止
chemistry\tn.  化学
sweep\tv.  [swept-swept] 扫， 打扫， 拂； 扫过， 掠过，
unfriendly\tadj.  不友好的， 冷漠的
fourteenth\tnum. 第十四 n.  十四分之一
learn\tv.  [learnt/learned-learnt/learned]　学， 学习； 获悉， 了解； 记住； 认识到
photo\tn.  照片
swing\tv.  [swang-swung] 摇摆， 摇荡； 回转， 旋转； 突然转向
handbag\tn.  手提包
fast\tadv. 快地；牢固地 adj. 　快的，　迅速的；　敏捷的
move\tv.  移动， 搬动， 搬； 动摇， 使改变主意； 感动， 激起； 进展， 发展
sweet\tadj.  甜的； 和蔼的， 温柔的； 可爱的， 讨人喜欢的； 芳香的， 悦耳的， 悦目的
thirtieth\tnum. 第三十 n.  三十分之一
couple\tv.  使成对； 结合， 结婚 n. 夫妻，情侣；数个
communicate\tv.  通信； 沟通； 传达； 传播； 传染
rural\tadj.  乡村的， 农村的
red\tadj. 红色的 n.  红色； 红颜料
spring\tn.  春天， 春季； 弹簧， 发条； 泉； 跳， 跃
act\tv.  行动， 做事； 表现； 起作用； 扮演， 表演
post\tn.  职位， 岗位 ； 柱， 标杆； 起点或终点标志
duck\tvi.  鸭子似的突然扎入水中； 突然低下 n. 鸭；鸭肉
leave\tv.  [left-left] 离开， 出发； 留下， 遗留； 遗忘； 听任， 让； 交托， 委托
finish\tv. 完成，结束 n.  结束， 末尾， 最后阶段
add\tv.  添加， 增加； 把…加起来， 计算…的总和
computer\tn.  计算机， 电脑
cruel\tadj.  残忍的， 残暴的
its\tpron.  它的
ninth\tnum. 第九 n.  九分之一
often\tadv.  常常， 经常
insist\tv.  坚持要求， 强调； 坚决主张； 坚持说， 固执地声称
seventeenth\tnum. 第十七 n.  十七分之一
article\tn.  一件； 物件， 商品； 文章， 论文； 条款， 条文， 规定； 冠词
shelf\tn.  架子， 搁板
ache\tv. 痛，疼痛；渴望 n.  疼痛
...
useful\tadj.  有用的， 有益的
trust\tv.  信任， 信赖； 希望， 想； 确信； 托付； 对…放心 n. 信任，信赖；受托
blackboard\tn.  黑板
private\tadj. 私人的，个人的；秘密的，私下的；私立的，私营的 n.  士兵， 列兵
choose\tv.  [chose-chosen] 选择， 挑选
ride\tv.  骑； 乘
jeans\tn.  牛仔裤
prevent\tv.  阻止， 妨碍
behave\tv.  表现； 表现得体， 有礼貌； 运转； 起作用
sorry\tadj.  对不起的， 抱歉的； 遗憾的， 惋惜的； 可怜的，
medal\tn.  奖牌， 奖章
end\tv.  结束， 终止 n. 最后部分，末尾；死亡；终止，结局；结果，目标
forty\tnum.  四十
mistake\tn. 〔行为、看法、言辞等上的〕错误 v. 弄错，误解，误会
pour\tv.  灌， 倒； 倾泻， 流出
rich\tadj.  富的， 有钱的； 富饶的， 充足的； 盛产的； 油腻的； 浓郁的；
message\tn.  信息， 便条， 口信； 要点； 要旨
rice\tn.  稻； 大米； 米饭
praise\tv. 赞扬，表扬 n.  称赞， 赞美； 赞美的话
special\tadj.  特殊的， 特别的； 专门的， 特设的； 附加的，
environment\tn.  周围状况， 环境
truth\tn.  事实， 真相； 真实性； 真理
Asia\tn.  亚洲
airplane\tn.  飞机
pronounce\tv.  发音； 宣布； 宣判
family\tn.  家； 家庭成员； 子女； 家族， 氏族
age\tn.  年龄； 老年； 时代， 时期； 很长的一段时间
gift\tn.  礼物， 赠品； 天赋， 才能
college\tn.  大学， 学院
popcorn\tn.  爆米花
ago\tadv.  以前
number\tv.  给…编号 n. 数目，数字；号码，编号
punish\tv.  惩罚， 处罚
brave\tadj.  勇敢的， 无畏的
must\tn.  必须做的事； 必备之物
similar\tadj.  相似的， 类似的
shape\tn.  形状， 体形； 幻象； 状况， 状态
seventy\tnum.  七十， 七十个
nothing\tpron.  没有东西， 没有事情， 一点儿也没有； 无关紧要的人
seventh\tnum. 第七 n.  七分之一
spot\tn.  地点， 处所； 斑点， 污点； 少量
silver\tv.  镀银 n. 银；银器；银币
aid\tv.  帮助， 救助 n. 帮助，救助；助手；辅助手段
other\tadj.  别的， 其他的， 另外的； 另一的， 其余的
singer\tn.  歌手
aim\tv.  瞄准， 对准； 目的是， 旨在； 针对； 力争做到 n. 目的，目标；瞄准
city\tn.  城市， 都市
against\tprep.  逆， 反， 违反； 对…不利； 倚在， 紧靠着， 紧贴着； 和…比， 和…对照
confident\tadj.  确信的， 肯定的； 有信心的， 自信的
uncle\tn.  伯父， 叔父， 舅父， 姑父， 姨父
air\tn.  天空； 空气， 大气； 样子， 神态
holiday\tn.  假期， 假日
courage\tn.  勇气， 胆量
...
share\tv. 分享，分担；分摊，分开 n.  一份； 份儿， 股份
restroom\tn.  洗手间； 休息室
polar\tadj.  地极的， 近地极的； 磁极的； 正好相反的， 截然对立的
shark\tn.  鲨鱼； 勒索者， 诈骗者； 放高利贷的人
chairman\tn.  主席； 会议主持人； 董事长
boat\tn.  船， 小船
future\tadj. 将来的，未来的 n.  将来， 今后； 前途， 前景
more\tadv. 更，更多 adj.  更多的； 更大的
shake\tn&v.  [shook-shaken] 摇动， 摇； 颤抖， 震动
cent\tn.  分， 分币
honor\tv.  尊敬 n. 尊敬，敬意；荣誉，光荣
screen\tv.  掩蔽， 遮蔽， 包庇； 放映， 播放(电视 n. 屏幕，银幕；遮蔽；屏风
body\tn.  身体， 躯体； 躯干， 主体； 尸体； 物体； (视作
cage\tn.  笼子
unhealthy\tadj.  不健康的
insect\tn.  昆虫， 虫
net\tadj.  净的， 纯的 n. 网；网状系统
always\tadv.  总是， 无例外地； 永远， 始终， 一直
all\tadv.  完全地； 十分， 很 adj. 一切的，所有的；全部的，总的，整个的
border\tv.  给…加上边， 围； 邻接， 毗连； 近似， 接近 n. 边，边缘；边界，边境
read\tv.  [read-read]　读， 阅读； 朗读， 宣读； 读懂； 观
below\tprep.  在…下面， 到…下面； 在…以下； 低于
already\tadv.  早已， 已经
shall\tmodal verb. 〔某事〕必定，一定〔发生〕
touch\tv. 触摸，碰到；接触，涉及 n.  接触， 碰到； 触觉； 修饰， 润色； 风格， 手法
clock\tn.  钟
real\tadj.  真的， 真正的； 真实的， 现实的
tool\tn.  工具， 用具； 方法， 手段
April\tn.  四月
unit\tn.  单位； 单位； 部件， 元件， 装置； 单元
nearby\tadv.  在附近 adj. 附近的
Sunday\tn.  星期日
model\tn.  模型； 模特儿； 模范， 典型
collect\tv. 收集，采集；收；领取；聚集，汇集 adj.  由对方付费的
shame\tv.  使蒙受羞辱 n. 羞耻，羞愧；可耻的人；遗憾的事，可惜
around\tadv. 在周围，在附近；到处，四周；大约 prep.  在…各处， 遍及； 在…四周； 在
pronoun\tn.  代词
and\tconj.  和， 与， 及； 那么， 则； 然后， 接着； 而且， 还
today\tadv&n.  今天； 现今
...
OK\tadv&int.  不错， 很好； 对吧
raincoat\tn.  雨衣
abroad\tadv.  到国外； 广为流传 adj. 在国外；广泛四散
fifteen\tnum.  十五
ant\tn.  蚂蚁
pencil\tn.  铅笔
specific\tadj. 特定的，特有的；明确的，具体的
any\tpron. 无论哪个，无论哪些 adj.  任一的， 任何的； 什么， 一些； 丝毫的
minute\tn.  分， 分钟； 一会儿， 片刻； 此时此刻， 立刻
super\tadj.  极好的， 上等的； 超级的； 过分的
chore\tn.  家庭杂务； 困难的工作； 令人厌烦的工作
semester\tn.  学期
until\tprep&conj.  直到…时， 到…为止； 直到…
strategy\tn.  谋略， 战略， 策略
dull\tadj.  乏味的， 单调的； 晦暗的； 愚钝的， 笨的； 钝的
reason\tv.  推断， 分析； 推论， 推理； 理喻， 劝告 n. 原因，理由；理性，理智
thought\tn.  想法， 见解； 思考， 思维； 关心， 注意； 思想，
ring\tn.  戒指； 环， 圆圈； 铃声； 电话； 团伙， 帮派； 拳击台， 摔跤台， 马戏场
legend\tn.  传说； 传奇人物
taste\tv.  有…味道； 品尝； 体验， 感受 n. 滋味；味觉，口味；鉴赏力；兴趣，爱好
ship\tv.  用船运； 装运， 运送 n. 船，舰
anywhere\tadv.  在什么地方， 在任何地方； 随便什么地方
...
shoulder\tv.  肩负， 承担 n. 肩
dance\tv.  跳舞 n. 舞，舞蹈；舞曲，舞会
boil\tv. 沸腾，煮沸 n.  沸腾
remain\tv.  仍然是， 依旧是； 留下， 逗留； 剩余， 余留； 留待
eye\tn.  眼， 眼睛； 虹膜； 眼状物
himself\tpron.  他自己； 他亲自， 他本人
toilet\tn.  厕所， 盥洗室
envelope\tn.  信封
dictionary\tn.  词典， 字典
slow\tadv.  慢慢地 adj. 慢的；迟钝的，不灵巧的；不忙碌的 v. 慢下来，减速
turkey\tn.  火鸡； [T-] 土耳其
letter\tn.  信， 函件； 字母
tasty\tadj. 美味的；引起食欲的 n.  好吃的东西； 吸引人的东西
maybe\tadv.  大概， 也许
another\tpron. 再一个，另一个 adj.  又一的， 再一个的； 另一的， 别的； 不同的
enemy\tn.  敌人， 仇敌
worth\tadj. 相当于…价值的，值得…的 n.  价值， 财产
new\tadv.  新近 adj. 新的；新鲜的，新型的，流行的；更新的
helicopter\tn.  直升机
are\tv.  存在， 是
advertisement\tn.  广告， 公告； 广告活动， 宣传
disabled\tadj.  有残疾的
watermelon\tn.  西瓜
arm\tv.  以装备； 提供， 配备； n. 臂，前肢；臂状物，扶手；
popular\tadj.  流行的， 通俗的， 大众的； 受欢迎的
art\tn. 美术，艺术；技术，技艺；
mom\tn.  妈妈
black\tadj.  黑色的； 黑暗的； 黑人的； 不加奶的； 黯淡的， 毫无希望的
tour\tn&v.  旅行， 旅游
call\tv.  把…叫做， 把…称为； 打电话给； 叫， 大声说出； 召唤， 传唤； 召开，
calm\tadj. 镇静的，镇定的；平静的，无风的 v.  平静； 镇静
such\tadv.  那么 adj. 这样的，这种的；那么的，如此程度的；上述的，该
kick\tn&v.  踢
ask\tv.  询问， 问； 要求
describe\tv.  描写， 描述； 说明
through\tadv.  从头到尾， 自 prep. 穿过，通过；在整个…期间，从头到尾；凭借，经由
jazz\tadj.  爵士乐的 n. 爵士乐
run\tv.  [run-run, running] 跑， 奔跑； 行驶， 驾驶； 蔓延， 伸展； 操作； 竞
either\tadv.  也 adj. 任一的，每一的
view\tv.  考虑， 认为； 观察， 看 n. 看法，观点；视野，眼界；景色，风景
ours\tpron.  我们的
white\tadj. 白色的，白的；白种的 n.  白色； 蛋白； 眼白
furniture\tn.  家具
huge\tadj.  庞大的， 巨大的
yourself\tpron.  你自己； 你亲自
donate\tv.  捐赠， 赠送
helpful\tadj.  有益的， 有用的； 给予帮助的， 肯帮忙的
those\tpron.  那些
worry\tv. 担心，发愁；困扰，折磨 n.  担心， 发愁， 忧虑
imagine\tv.  想象， 设想； 料想， 猜想
town\tn.  镇， 市镇； 市区， 市中心
might\tmodal verb. 可以〔用于礼貌地提出建议〕 n. 力量；威力；权力
telephone\tv.  打电话 n. 电话
girl\tn.  姑娘， 女孩； 女儿
delicious\tadj.  美味的； 芬芳的； 宜人的
worse\tadj. 更坏的；更糟的；更差的 n. 更差[坏]的事物 adv. 更严重地；更厉害地
whatever\tpron.  无论什么， 不管什么； 任何…的事物， 凡是…的东西
camp\tv.  露营， 扎营 n. 营地，露营
volunteer\tv.  自愿 n. 志愿者，志愿兵
museum\tn.  博物馆
everywhere\tadv.  到处， 各处， 无论何处
...
truck\tn.  卡车， 载重汽车； 敞篷货车
book\tv.  预订，　预约 n. 书，书籍；本子，簿册；
show\tv.  表明， 证明； 显示， 出示； 带领； 教， 告知； 演出， 放映； 显现，
nor\tconj&adv.  也不， 也没有
Mars\tn.  火星； 战神
not\tadv.  不， 没， 不是
arrive\tv.  到达， 到来； 来临； 达到， 达成
street\tn.  街道， 马路
now\tadv.  现在， 如今； 此刻
statement\tn.  陈述， 声明； 结算单， 报表
Tuesday\tn.  星期二
shoe\tn.  鞋
race\tn.  比赛， 赛跑； 竞争； 人种， 种族
near\tadv. 近，在近处 adj.  近的， 接近的； 亲近的 prep. 靠近，接近
introduce\tv.  介绍； 引进， 传入； 提出供讨论； 采用
war\tn.  战争； 斗争， 竞争
way\tn.  方法， 手段； 路， 路线； 方面； 方向； 习俗， 作风； 状况， 状态
what\tpron.  什么； 多么， 何等…的事物
duty\tn.  责任， 义务； 职责， 职务； 税， 关税
risk\tv.  冒…的危险， 使遭受危险 n. 危险，风险；引起危险的事物；冒险
window\tn.  窗户， 窗口
rise\tv.  [rose-risen] 升起， 上升； 起立； 起床； 上涨， 增加； 反抗， 起义
penny\tn.  便士， 分
play\tv.  玩， 游戏； 演奏， 播放； 扮演， 演出； 参加， 打
yard\tn.  院子， 场地； 码
decide\tv.  决定， 对…作出抉择； 使下决心
rent\tv. 租借，租用；出租，出借 n.  租金； 出租； 裂缝， 分歧
when\tadv. 什么时候，何时；在…的时候 conj.  在…时， 当…时； 然后
fan\tv.  煽动， 激起 n. 扇子；扇形物；狂热爱好者，迷
anxious\tadj.  焦虑的， 发愁的， 令人焦急的； 渴望的， 急
slice\tv. 切成片，削 n.  薄片， 切片； 一份， 部分
far\tadv. 远；久远；很大程度上，极 adj.  远的，　远方的；　久远的
fat\tadj. 肥胖的；多脂肪的 n.  脂肪； 肥肉
catch\tv.  [caught-caught] 抓住， 接住； 偶然撞见； 染上， 感染； 赶上， 追上；
fax\tv.  传真 n. 传真；传真电文
plan\tn.  计划， 打算， 规划； 平面图， 示意图； 设计图
case\tn.  事例， 实例； 情况， 事实； 病例； 案件； 箱， 盒； 手提箱
give\tv.  [gave-given] 给予， 赠送； 供给， 提供； 做出， 发出
double\tadj.  双的， 双重的； 两倍的， 加倍的； 供两人用的， 双人的； 两面派的， 虚伪的
eighteen\tnum.  十八
phone\tv.  打电话 n. 电话，电话机
comfortable\tadj.  舒适的， 舒服的； 宽裕的， 小康的
slide\tv. （使）滑行，（使）滑动 n. 滑梯
style\tn.  风格， 文体； 式样， 类型； 流行式样， 时尚
jungle\tn.  丛林， 密林
suit\tn.  一套衣服； 套
card\tn.  卡， 卡片； 请帖； 贺卡； 纸牌
Yin\tn.  阴
chocolate\tn.  巧克力； 巧克力色
care\tv. 关心，关怀；担心；介意 n.  照顾， 护理； 小心， 注意； 忧虑； 挂念
study\tv. 学习；研究，调查；细察，仔细端详 n.  学习； 研究， 调查， 研究成果； 书房
boss\tn.  老板， 上司， 头儿
direct\tadv. 直接地 adj. 直接的；率直的，坦率的；顺行的 v.  把…对准， 针对； 管理；
exercise\tn.  锻炼， 运动； 练习， 习题； 运用， 行使； 操练， 演习
fever\tn.  发热， 发烧； 狂热
supermarket\tn.  超市
madam\tn.  女士， 夫人
kilo\tn.  千克
...
wet\tadj. 湿的，潮的；多雨的，雨天的 v.  把…弄湿， 使潮湿
born\tadj.  出生的， 产生的； 天生的
kill\tv.  杀死， 扼杀； 终止， 否决； 使疼痛， 使非常痛苦； 消磨， 打发
wrong\tadj. 错误的，不正确的；不道德的，不正当的，不合法的 n.  错误； 坏事； 不公
porridge\tn.  粥， 麦片粥
shirt\tn.  衬衫
criticize\tv.  批评； 评论； 非难
certain\tadj.  某一， 某种； 肯定的， 确信的； 确实的， 无疑的
board\tn.  板， 牌子； 木板， 纸板； 委员会， 董事会， 理事会； 伙食
shut\tv.  [shut-shut, shutting]　关闭， 关上； 打烊
luck\tn.  运气； 好运， 幸运
simple\tadj.  简单的； 朴素的； 单纯的， 直率的； 迟钝的， 头脑简单的
autograph\tv.  签名 n. 亲笔签名
eleventh\tnum.  第十一
influence\tv.  影响， 感化 n. 影响，影响力；产生影响力的人；势力，权势
cloud\tv.  使模糊， 使阴暗； 遮盖， 笼罩 n. 云；一群，一团；阴影；天空
whale\tn.  鲸
talent\tn.  天资， 才能； 人才
few\tpron.  很少人；　有些，　一些 adj. 很少，几乎没有
rain\tv.  下雨 n. 雨；雨天；雨季
violin\tn.  小提琴
king\tn.  君主， 国王； 巨子， 大王
kind\tadj.  亲切的， 和蔼的， 仁慈的 n. 种类
both\tpron.  两者， 双方 adj. 两个…
market\tv.  销售， 出售 n. 市场；股市
important\tadj.  重要的， 重大的； 有势力的， 有地位的
keen\tadj.  热心的； 激烈的； 敏锐的
nine\tnum.  九， 九个
phrase\tv.  用语言表达， 叙述 n. 短语，词组，用语
outside\tadv. 在外面，向外面 adj.  外面的， 外部 prep. 在…外面，向…外面；除…以外
daily\tadv. 每日，天天 adj. 每日的；日常的 n.  日报
keep\tv.  [kept-kept] 使保持， 使继续； 阻止， 防止； 履行， 遵守； 保存， 保
yoghurt\tn.  酸奶， 酵母乳
elementary\tadj.  基本的， 基础的； 初级的， 小学的
topic\tn.  题目， 话题； 主题
skate\tv.  溜冰， 滑冰 n. 冰鞋
job\tn.  职业， 职位； 工作， 活儿； 职责， 责任
sugar\tv.  在…中加糖 n. 糖
daughter\tn.  女儿
who\tpron.  谁， 什么人； …的人； 他， 她， 他们
game\tn.  游戏， 娱乐； 运动， 比赛
why\tadv. 为什么；…的理由 int.  咳， 哎呀
forbid\tv.  [forbade-forbidden] 不许， 禁止； 妨碍， 阻止
captain\tn.  船长， 机长； 上尉； 队长， 领队
bowl\tn.  碗， 钵
alone\tadj.  单独的， 孤独的； 单单， 仅； 独一无二的， 唯一的
along\tadv. 向前地；一道，一起 prep.  沿着， 循着
joy\tn.  欢乐， 喜悦； 乐事， 乐趣
dialogue\tn.  对话
America\tn.  美国； 美洲
sad\tadj.  悲哀的， 伤心的； 十分糟糕的， 令人伤心的
diet\tv.  进特种饮食， 节食 n. 日常饮食；特种饮食，规定饮食
win\tv. 〔在竞赛、游戏、选举等中〕获胜，赢 n. 〔尤指在体育比赛中的〕胜利，赢
sheep\tn. 羊，绵羊
rest\tv.  休息， 睡眠； n. 剩余部分，其余的人；休息；停止，静止；撑架，支座
soccer\tn.  足球
butter\tn.  黄油
amount\tv.  合计 n. 总额
...
sandwich\tv.  把…做成三明治； 夹入， 挤进 n. 三明治，夹肉面包
enough\tadv. 足够地，充分地；相当，达到一定的程度 adj.  足够的
increase\tn.  增加， 增强； 增加， 增强
shine\tv. 照耀；发光，发亮；干得出色 n.  光泽， 光
spread\tv. 展开，伸开；散布，蔓延；涂，敷 n.  传播， 蔓延； 幅度， 范围； 涂抹在食物上
afternoon\tn.  下午， 午后
attention\tn.  注意力， 专心； 关注； 关心； 立正姿势
shiny\tadj.  光亮的， 有光泽的； 反光的
visit\tn&v.  参观， 访问
headache\tn.  头痛； 令人头痛的人
front\tadj.  前面的， 在前面的 n. 前面，正面；前线，战线
oneself\tpron.  自己， 自身； 亲自， 本人
plane\tn.  飞机； 平面， 水平面
parent\tn.  父亲， 家长
stupid\tadj.  愚蠢的， 迟钝的； 无聊的； 恼人的
bad\tadj.  坏的； 不利的； 差的， 有缺陷的； 邪恶的， 道德败坏的； 严重的， 厉害的；
bring\tv.  [brought-brought] 带来， 拿来； 把…引来； 促使， 使发生
bag\tv.  把…装进袋子 n. 袋；手提包，旅行袋
sauce\tn.  沙司； 调味汁， 酱汁； 佐料
awake\tadj. 醒着的 v.  [awoke-awaken] 醒， 唤醒； 意识到， 醒悟
kiss\tn&v.  吻
hamburger\tn.  汉堡包
offer\tv. 给予，提供；表示愿意；提出，提议 n.  提供， 提议； 报价， 开价
fit\tv. 可容纳，装进 adj. 〔尤因经常锻炼而〕健壮的，健康的 n. 〔感情的〕冲动，一阵发作 v. 〔疾病〕发作，突发
robot\tn.  机器人； 自动机械
fix\tv.  修理； 固定； 安装； 安排， 确定； 整理， 收拾； 供给或准备
need\tv. 需要；必须 n.  需要， 必要； 缺乏； 迫切要求
honest\tadj.  诚实的， 正直的； 坦诚的， 直率的
rank\tv.  排列， 使排成行； 将…分等级； 属于某等级， 居某地位 n. 等级；军衔，职衔
cinema\tn.  电影院； 电影， 电影艺术
rubbish\tn.  垃圾， 废物； 荒谬的念头； 废话
surf\tv.  冲浪； 冲浪， 浏览 n. 拍岸浪花；拍岸涛声；拍岸碎浪
sure\tadv.  确实； 当然 adj. 肯定的，有把握的；一定的，必然的；可靠的，稳妥的
angry\tadj.  生气的， 发怒的， 愤怒的
am\tv.  是
an\tindefinite article. 一（个）〔用于以元音开头的单词前〕
fold\tv.  折叠， 合拢 n. 褶痕，褶缝
as\tadv. 同样，一样地 prep.  当做， 作为； 像， 如同
plastic\tadj. 塑料的；可塑的
mysterious\tadj.  神秘的， 难以理解的
plant\tn.  植物； 作物； 工厂
peace\tn.  和平， 和睦； 平静， 安宁， 安静
drive\tv. 驱赶，驱使，迫使…去〔某处〕 n. 驱车出行
Atlantic\tadj. 大西洋的 n.  大西洋
brother\tn.  兄弟； 教友， 会友
hurt\tv. 弄伤 adj. 痛的；受伤的 n. 〔对感情造成的〕伤害，痛苦
strong\tadj.  强壮的， 强有力的， 强大的； 牢固的； 坚强的， 坚定的； 强烈的， 浓的； 精
deal\tv. 发放；给予；处理，对付 n.  交易； 协议； 大量， 很多
prove\tv.  证明， 证实； 结果是， 原来是
be\tv.  是， 就是； 在， 存在
homeland\tn.  祖国， 家乡
maths\tn.  数学
deaf\tadj.  聋的； 不愿听的， 装聋的
dead\tadv.  完全地； 绝对地 adj. 死的；无感觉的；呆板的 n. 死者
mouth\tn.  嘴， 口
...
popularity\tn.  普及； 流行
mountain\tn. 山；
by\tprep.  被， 由； 凭借， 通过； 从…旁过去， 经由； 在…旁边， 靠近； 在…之前，
whom\tpron.  谁
wheat\tn.  小麦； 淡黄色； 朴实的人
dear\tadj. 亲爱的；昂贵的 int. 啊，哎呀 n.  亲爱的人
tooth\tn. 牙，牙齿
foot\tn. 脚，足
sixty\tnum.  六十， 六十个
...
escalator\tn.  〈美〉自动扶梯
medicine\tn.  内服药； 医学； 内科学
flu\tn.  流行性感冒
food\tn.  食物， 食品
fly\tv. 乘飞机 v. 〔棒球中〕击腾空球，击高飞球 n. 蝇，苍蝇 adj. 时髦漂亮的
...
spider\tn.  蜘蛛
kite\tn.  风筝； 纸鸢
interview\tv.  面试； 会见， 采访 n. 接见，会见；面谈，面试
bed\tn.  床； 床位； 床； 河床； 底
bee\tn.  蜜蜂
...
Friday\tn.  星期五
scary\tadj.  恐怖的， 吓人的
which\tpron.  哪一个， 哪一些； …的那个， …的那些； 那个， 那些
...
piece\tn.  片， 块， 段； 断片， 碎块
western\tadj.  西方的， 西部的
carry\tv.  提， 挑， 背； 运送， 运载； 输送， 传送， 传播； 携带， 怀着； 支撑
refrigerator\tn.  电冰箱
elephant\tn.  象
party\tn.  社交聚会； 党， 政党； 一方， 当事人
little\tadj.  小的， 矮小的； 短的； 琐碎的， 微不足道的； 不多的， 少到
however\tadv. 然而，仍然；无论如何 conj.  不管怎样， 然而
deep\tadj.  深的， 厚的； 深切的， 强烈的； 深沉的； 浓的； 深刻的， 深
shy\tadj.  腼腆的， 害羞的； 胆怯的； 有戒心的， 畏缩的
for\tprep.  为， 为了； 给， 供； 代替， 代表； 因为， 由于； 就…而言； 往， 向
fox\tn.  狐狸； 狡猾的人
perhaps\tadv.  或许， 大概， 可能
aunt\tn.  姑姑， 姨妈， 伯母， 婶婶， 舅妈
skill\tn.  技能， 技巧， 手艺； 熟练
oak\tn.  橡树； 橡木
trouble\tn.  麻烦， 苦恼， 困难； 疾病； 故障； 纠纷， 动乱
divide\tv. 分，分隔；分配，分享；除；使产生分歧 n.  分歧； 分开； 分界线， 分水岭
sir\tn.  先生； [S-] 爵士
class\tn.  阶级， 社会等级； 班， 班级； 课； 种类， 门类； 等级， 级别
sit\tv.  [sat-sat, sitting] 坐， 就座； 坐落， 被安放； 使坐， 使就座
over\tprep.  在…上方， 在…上面； 越过， 从一侧到另一侧； 高于， 超过； 在…期间；
six\tnum.  六， 六个
football\tn.  足球； 橄榄球
dinner\tn.  正餐， 主餐； 宴会
fork\tn.  叉， 餐叉； 耙； 分叉， 岔口
form\tv.  形成， 构成 n. 形式，种类；外形，外貌；表格
farmer\tn.  农场主； 农民
neither\tadv.  也不 pron. 两者都不
avoid\tv.  避免； 避开， 躲开； 预防
gate\tn.  大门； 有大门的出入口； 观众人数， 门票收入
fresh\tadj.  新的， 新到的； 新鲜的， 未经腌熏的
he\tpron.  他； 一个人
very\tadv. 很，非常；极其，完全地；正是 adj.  正是的， 恰好的； 完全的， 十足的
big\tadj.  大的， 巨大的； 重大的， 主要的； 年龄较大的， 长大了的
practice\tn.  实践； 实践行动； 练习； 惯例， 习俗
crowd\tv.  聚集， 群集； 挤， 推 n. 人群，群众；一群，一批
sick\tadj.  有病的， 患病的； 恶心的， 想吐的； 厌恶的； 心烦意乱的， 恼火的
bit\tn.  一点儿， 少许； 小片， 小块
corner\tn.  角， 角落； 街角； 遥远的地区， 偏僻处； 困境，
else\tadv.  其他， 另外
four\tnum.  四
easily\tadv.  容易地， 不费力地
beside\tprep.  在…旁边； 在…附近； 和…相比
join\tv.  参加， 加入； 连接， 接合
if\tconj.  如果， 假如； 是否； 即使， 虽然
costume\tn.  戏装； 成套服装
bathroom\tn.  浴室； 盥洗室
sky\tn.  天
sentence\tv.  宣判， 判决 n. 句子；判决，宣判
hallway\tn.  走廊， 回廊； 门厅， 过道
large\tadj.  大的； 多的， 众多的
surface\tv.  浮出水面； 浮现， 显露 n. 表面，面；外表，外观
in\tprep.  在…里， 在…内； 在…期间， 在…之内；
tomorrow\tadv. 明天 n.  明天； 来日， 未来
verb\tn.  动词
metal\tn.  金属
is\tv.  存在， 是
it\tpron.  它； 他； ；
...
alive\tadj.  活着的， 在世的； 存在的， 在起作用的； 有活力的， 活跃的， 有生
weekend\tadj.  周末的 n. 周末
noodle\tn.  面条
plate\tn.  盘子； 金属牌； 感光底片
world\tadj.  世界的， 世界范围的 n. 世界，地球，天下；领域
library\tn.  图书馆， 藏书室； 藏书
ability\tn.  能力， 本领； 才能， 才智
everything\tpron.  每件事， 一切； 最重要的东西
camera\tn.  照相机； 摄影机， 摄像机
table\tn.  桌子， 台子； 表格
bread\tn.  面包； 生计， 谋生之道
side\tn.  面， 侧面， 旁边； 方面； 一方， 一边； 山坡， 坡， 岸
break\tv.  [broke-broken] 打破； 损坏， 弄坏； 破坏， 违反； 中止， 中断； 打破；
restaurant\tn.  餐馆， 饭店
change\tv. 改变；交换，互换；兑换；换衣，换车 n.  改变， 变化； 更改， 更换；
draw\tv.  [drew-drawn] 画， 描绘； 拖， 拉； 拔出， 抽出； 提取， 汲取； 引起； 吸引； 推
cupboard\tn.  柜橱
off\tadv.  距， 离， 到； 离开； 出发， 起跑； 不发生， 取消； 断开， 不供
joke\tn.  笑话， 玩笑
knee\tn.  膝， 膝盖
hide\tv. 把…藏起来，隐藏 n. 〔可观察鸟兽行动的〕隐匿处，埋伏处
century\tn.  世纪， 百年
instruction\tn.  命令， 指示； 教学， 教导
discovery\tn.  发现， 发觉； 被发现的事物
candle\tn.  蜡烛
report\tv.  报告， 汇报； 报道； 告发； 报到； 隶属， 对负责
complete\tadj. 十足的，彻底的；完成的 v.  完成， 结束
fun\tadj. 有趣的，令人愉快的 n.  有趣的事； 乐趣， 娱乐
theirs\tpron.  他们的
sign\tv.  签； 签署 n. 标志，符号；招牌；征兆，迹象
several\tadj.  几个， 若干
cotton\tn.  棉， 棉花； 棉线， 棉纱
office\tn.  办公室， 办事处， 营业所； 处， 所， 局； 公职， 官职， 职责； 帮忙， 服务
while\tconj. 当…的时候，和…同时；而，然而；虽然，尽管 n.  一会儿， 时间
northern\tadj.  北方的， 北部的
second\tadj. 次等的，二等的 num. 第二 n.  秒， 瞬间
...
high\tadj.  高的， 高度的； 高级的， 重要的； 高兴的， 愉快的； 正盛
edge\tn.  边， 边缘； 刀口， 刃； 优势， 优越地位
son\tn.  儿子； 孩子
skirt\tn.  裙子； 边缘， 外围
than\tconj. 比 prep.  与…比较
me\tpron.  我
level\tadj.  平的， 水平的； 同高度的， 同程度 n. 水平面，水平线；高度；水平，等级
author\tn.  作家， 作者； 创始人， 发起者
Europe\tn.  欧洲
meter\tn.  米， 公尺
infinitive\tn.  原形； 不定式
establish\tv.  建立， 设立； 确定， 证实
coat\tv.  涂 n. 上衣，外套；表皮，皮毛；覆盖物，层
...
birthday\tn.  生日
heat\tv.  加热， 变热 n. 热，炎热；体温，热度；激动；激烈
behind\tprep.  在…的背后， 在…的后面； 落后于； 支持， 赞
tenth\tnum. 第十 n.  十分之一
candy\tn.  糖果
student\tn.  学生， 学者， 大学生； 研究生
careful\tadj.  小心的， 仔细的
recipe\tn.  烹饪法， 食谱； 方法； 秘诀， 诀窍
seal\tv.  封， 密封 n. 封铅，封条；印，图章；海豹
box\tv.  把…装箱； (用拳或手 n. 箱，盒；包厢
bow\tn&v.  鞠躬， 低头； 鞠躬， 低头
boy\tn.  男孩
head\tn.  头， 头部； 顶部， 前端； 领导， 首脑； 头数； 头脑， 智力
month\tn.  月， 一个月的时间
total\tadj. 总的，全部的；完全的，彻底的 v.  合计， 总计 n. 总数，总计
oil\tv.  给…加润滑油； 使涂满油 n. 油；润滑油；石油，燃料油；油画；油画颜料
upstairs\tadv. 在楼上，往楼上 adj. 楼上的 n.  楼上
of\tprep.  …的； 由…制成的； 含有…的， 装有…的
fight\tv. 打（仗），与（…）作战，战斗 n. 打斗，打架
hear\tv.  [heard-heard] 听见； 听到， 得知； 审讯， 听证； 收到…的信
on\tprep.  在…上； 向， 朝， 针对； 靠近…， 在…旁； 关于， 论及； 凭， 靠， 根据； 处
zebra\tn.  斑马
pretty\tadv. 相当，很，颇 adj.  漂亮的， 俊俏的
or\tconj.  或， 或者， 还是； 即， 或者说； 否则， 要不然
chance\tv.  碰巧， 偶然发生； 偶然看见 n. 可能性；机会，机遇；偶然的事
social\tadj.  社会的； 交际的， 社交的
wheel\tv.  转动， 旋转 n. 轮，车轮
homeless\tadj.  无家的， 无家可归的
cross\tv. 穿过，越过；交叉，相交；杂交 n.  十字架； 十字形记号
control\tv.  控制， 支配； n. 控制，支配；管理；调节；抑制，自制；控制器，调节器
cousin\tn.  堂兄弟， 堂姐妹
clerk\tn.  〈美〉店员； 办事员， 职员
...
they\tpron.  他们
noise\tn.  声音， 响声； 噪音
pleasure\tn.  高兴， 愉快； 满足； 乐事， 快事
old\tadj.  老的， 年老的； 古老的， 陈旧的， 过时的； …岁的， …久的； 以前的， 过去
them\tpron.  他们
then\tadv.  当时， 在那时； 那么， 因而； 然后， 于是
ancient\tadj.  古代的， 古老的； 年老的， 看上去很老的
accept\tvt.  接受； 承认； 相信
zigzag\tadj. “之”字形的 v.  弯弯曲曲行进 n. “之”字形；蜿蜒曲折
seat\tv.  使坐下； 供给…座位， n. 座位，座部；所在地，场所；席位，职位
horse\tn.  马
twelve\tnum.  十二， 十二个
London\tn.  伦敦
...
autumn\tn.  秋， 秋季
bridge\tv.  架桥于； 把…连接起来 n. 桥，桥梁；桥牌
conference\tn.  会议； 讨论， 商谈
activity\tn.  活动， 行动； 活跃， 活力
dormitory\tn.  宿舍
recite\tv.  背诵， 朗诵； 列举， 逐一讲述
...
secretary\tn.  秘书； 书记； 部长， 大臣
heel\tn.  脚后跟， 踵； 后跟
disturb\tv.  弄乱， 打乱； 打扰； 使烦恼
so\tadv.  如此， 那么； 非常， 很； 这样， 那样；
pierce\tv.  刺穿， 刺破， 穿透； 穿孔， 打眼
key\tn.  钥匙； 关键， 要害； 键； 调； 答案， 题解； 图例
teenager\tn.  十几岁的青少年
calendar\tn.  日历， 月历； 日程表
silk\tn.  丝， 丝绸
dumpling\tn.  饺子
silent\tadj.  寂静的； 沉默的； 无声的， 不发出声音的
storm\tv.  猛攻， 直捣； 怒气冲冲地走 n. 暴风雨，暴风雪；激动，爆发
one\tpron.  一人， 一个； 一个人， 任何人 num. 一，一个
garage\tn.  车库； 汽车修理行
slipper\tv.  用拖鞋打 n. 拖鞋；轻便舞鞋
store\tv.  贮藏， 储备， 存储 n. 商店，店铺；贮存，储备；储备品；仓库
flower\tv.  开花； 发育， 成熟； 繁荣 n. 花；花卉
single\tadj.  单一的， 单个的； 未婚的， 独身的； (床或
hill\tn.  小山， 山冈； 斜坡
pull\tv. 拉，拖，拔；移动 n.  拉， 拖； 拉力， 牵引力， 引力
subway\tn.  地铁； 地道， 地下过道
to\tprep.  向， 往， 对着； 对， 给， 于； 趋于， 倾向； 直到…为止， 在…之前； 比， 对；
fourth\tnum. 第四 n.  四分之一
story\tn.  故事， 传说， 小说； 情况， 事情； 报道； 层
but\tadv.  只， 仅仅 conj. 但是，可是，然而；而 prep. 除…以外
country\tn.  国家； 国土； 国民， 全国人民； 农村， 乡村
symbol\tn.  符号， 标志； 象征
bus\tn.  公共汽车
separate\tv.  使分离， 使分开； 划分， 区分， 区别； 分离， 分开； 分居； 使分离， 使分开； 划分， 区分， 区别； 分离， 分开； 分居
dislike\tn&v.  不喜欢， 讨厌
buy\tv.  [bought-bought] 买， 买得； 向…行贿， 收买
express\tadv.  用快递方式； v. 表示，表达 adj. 特快的，直达的；明确的，明白表示的
ruler\tn.  统治者， 支配者； 尺
zero\tnum. 零 n.  零点， 零度
amazing\tadj.  令人惊异的
postcard\tn.  明信片
up\tadv. 向上，向较高处；往北；成直立姿势，起来；彻底地，完全地 n.  上升；　繁荣
...
this\tpron.  这， 这个
necessary\tadj. 必要的，必需的；必然的，势必的，不可避免的 n.  必需品
thin\tadv. 薄，细；稀疏 adj. 薄的；细的；瘦的；稀薄的；淡薄的 v.  变薄，
ocean\tn.  洋， 海洋； 许多， 大量
especially\tadv.  特别， 尤其， 格外
once\tadv. 一次，一回；曾经，一度 conj.  一旦…就…
solve\tv.  解决， 处理； 解答
desk\tn.  书桌， 办公桌
...
coin\tv.  创造 n. 硬币，钱币
drop\tv. 掉下，落下 n. 〔液体的〕滴
idea\tn.  想法， 主意； 思想， 概念
kid\tn. 小孩，儿童 v. (拿…)开玩笑
Yang\tn.  阳
cold\tadj. 冷的，寒冷的；冷淡的，冷酷的 n.  冷， 寒冷；
life\tn.  生命， 性命； 一生， 寿命； 生活， 生存； 人生； 生物； 生气， 活力
we\tpron.  我们
cola\tn.  可乐饮料
honey\tn.  蜜， 蜂蜜； 甜蜜； 宝贝儿， 亲爱的
normal\tadj.  正常的， 平常的； 正规的， 规范的
wide\tadv.  全部地， 充分地 adj. 宽阔的；广泛的；远离目标的，偏离的
teach\tv.  [taught-taught] 教， 讲授； 教导， 教训
argue\tv.  争论， 争吵， 争辩； 提出理由证明， 主张； 说服， 劝说
stone\tn.  石， 石头； 宝石； 果核
succeed\tv.  成功； 接着发生； 接在…后面； 接替， 继承
specially\tadv.  特意地， 专门地； 格外地， 特别地， 特殊地
accessory\tn.  附件， 零件， 配件； 装饰品
gentleman\tn.  有教养的人， 彬彬有礼的人； 先生， 男士
shampoo\tn. 洗发剂；洗涤剂 vt.  用洗发剂洗头
yogurt\tn.  酸奶， 酵母乳
reach\tv.  抵达； 达到； 延伸到； 伸出； 够到； 与…取得联系； 达成
competition\tn.  竞争； 比赛
none\tadv.  一点也不， 毫不， 毫无 pron. 没有一人，没有一点儿
type\tv.  打 n. 类型，种类；铅字
beyond\tprep.  在…的那边； 远于； 迟于； 超出， 非…所及
pupil\tn.  学生； 瞳孔
problem\tn.  问题， 疑难问题； 思考题， 讨论题
road\tn.  路， 道路； 途径
review\tn&v.  审查， 复查； 复习， 温习， 回顾； 评论； 检阅
sight\tn. 视力，视觉；看见，瞥见；视域，眼界；情景，景象，奇观；
weather\tn.  天气， 气候， 气象
asleep\tadj.  睡着的， 睡熟的
between\tprep.  在…之间； 介乎…之间
method\tn.  方法， 办法； 秩序， 条理
wife\tn.  妻子
come\tv.  [came-come] 来， 来到； 达到， 至； 产生， 来； 变成； 实现； 开始；
push\tv.  推， 按； 推动， 推进； 催逼， 逼迫
nature\tn.  大自然， 自然界； 本性， 性格， 性情； 性质， 类型
seventeen\tnum.  十七， 十七个
lift\tv. 提，抬起 n.  电梯； 抬， 上升； 搭便车
force\tn. 军事行动，武力 v. 强制，逼迫，迫使
scared\tadj.  惊恐的， 恐惧的
flag\tn.  旗， 旗帜； 标记
south\tadv. 向南方 adj.  南方的， 南部的， 来自南方的 n. 南，南部
musician\tn.  音乐家， 乐师
night\tn.  夜， 夜晚
north\tadv.  向北方 adj. 北方的，北部的；来自北方的 n. 北，北部
wear\tv.  穿着， 戴着， 留； 面露， 面带， 呈现； 磨损， 用旧
our\tpron.  我们的
weak\tadj.  虚弱的， 无力的； 弱的， 差的； 微
out\tadv.  出， 向外； 在外， 不在； 出
overseas\tadv. 在海外，在国外 adj.  海外的， 国外的，
rock\tv.  摇， 摇动 n. 岩石，石块；摇滚乐
impress\tv.  给…深刻印象， 使铭记
noon\tn.  正午， 中午
feature\tn. 特征，特色；
flat\tadj.  平的， 平坦的； 固定的， 统一的； 单调的， 沉闷的； 扁平的，
get\tv.  [got-gotten/got] 获得， 弄到； 收到； 变得； 拿来； 理解， 听到； 到达
dark\tadj. 暗的，黑暗的；深色的，黑色的 n.  黑暗， 暗处； 暗色， 阴影
course\tn.  过程； 经过； 路线， 航线； 方针； 课程
copy\tv.  抄写； 复印； 抄袭； 模仿， 仿效 n. 复印件，副本；本，份
place\tn.  地方， 地点， 场所； 住所， 寓所； 地位； 资格； 名次， 等级
regular\tadj.  规则的； 有规律的， 定期的； 整齐的， 匀称的； 正规的， 正式的； 常规的，
dare\tv. 敢，敢做
cook\tv. 烹调，煮，烧 n.  厨师， 炊事员
sell\tv.  [sold-sold] 卖， 出售； 推销
cool\tadj. 凉的，凉快的；冷静的，从容的；冷淡的 v.  变凉， 冷却； 失去热
tired\tadj.  疲劳的， 累的； 厌倦的， 厌烦的
suggest\tv.  建议， 提出； 使想起； 暗示
leaf\tn.  叶， 叶子； 张， 页； 薄金属片
brain\tn.  脑， 脑髓； 脑袋； 智慧
lead\tn.  铅； 铅
help\tv. 帮助，援助；有助于，促进 n.  帮助， 援助； 帮手， 佣人； 救命
expect\tv.  预期； 指望， 盼望； 要求
emotion\tn.  感情； 激情； 情绪
etiquette\tn.  礼节， 礼仪
Chinese\tadj.  中国的； 中国话的 n. 中国人；中国话，中文
queue\tv.  排队 n. 行列
date\tn.  日期， 日子； 时期， 年代； 约会， 约会的对象； 枣
magic\tadj.  有魔力的 n. 魔法，魔术；魔力，魅力
impolite\tadj.  不礼貌的， 粗鲁的
dress\tv.  给…穿衣 n. 连衣裙；衣服，服装
panda\tn.  熊猫
reveal\tv.  揭露， 揭示； 泄露； 展现， 显示
passage\tn.  段落， 章节； 通道； 流逝， 推移
onion\tn.  洋葱， 洋葱类植物
sound\tv.  发声， 发出响声； 测量…的深度， 探测； 听起来， 似 n. 声音，声响
own\tadj. 自己的 v.  有， 拥有
drum\tn. 鼓 v. 击鼓，打鼓
sausage\tn.  香肠， 腊肠
dozen\tadj.  一打的 n. 打，十二个
translate\tv.  翻译
drug\tn.  药， 药物； 麻醉药， 毒品
negative\tadj. 否定的；消极的；负的 n.  底片； 负数
realistic\tadj.  现实的； 现实主义的； 逼真的
twelfth\tnum. 第十二 n.  十二分之一
monster\tadj.  巨大的， 庞大的 n. 怪物；妖怪；巨人，巨兽，巨大的东西
plain\tadj. 清晰的，明白的；相貌平平的，无姿色的；不矫饰的，朴素的 n.  平原
should\tmodal verb. 应当，应该 〔用于提供或征求建议〕
only\tadv. 只，仅仅，才；不料，反而，结果却 adj.  唯一的， 仅有的； 最好的， 独一
create\tv.  创造； 创作； 引起， 产生
tag\tn. 标签，标牌 v. 给…加上标签，给…挂上标牌
blow\tv. 〔风〕吹，刮 n. 打击
sunny\tadj.  阳光充足的； 快活的
notebook\tn.  笔记本
proud\tadj.  骄傲的， 傲慢的； 自豪的， 得意的
like\tv. 喜欢；想要；希望，愿意
ugly\tadj.  难看的， 丑陋的； 有敌意的
earthquake\tn.  地震
towards\tprep.  向， 朝， 面对； 接近
person\tn.  人
safe\tadj.  安全的， 平安的； 牢靠的， 可靠的； 谨慎的， 稳健的 n. 保险箱，保险柜
send\tv.  [sent-sent] 送， 寄； 派遣， 打发； 发送； 发射
here\tadv. 在这里，到这里；在这一点上 int.  嘿
note\tn.  短笺， 便条； 记录， 笔记； 注解； 音调， 音符
everybody\tpron.  每人， 人人， 各人
week\tn.  星期， 周
sail\tv. 航行；驾驶；在…上航行 n.  帆； 航行
purpose\tn.  目的， 意图； 用途； 效果
regret\tn&v.  [regretted-regretted, regretting] 懊悔； 遗憾， 抱歉
line\tn.  线条， 界线； 条纹， 皱纹； 方针， 路线； 线路， 电话线； 线， 绳； 排， 行； 铁路
snake\tv.  蜿蜒； 弯弯曲曲地行进 n. 蛇
flee\tv.  [fled-fled] 逃离， 逃跑
hero\tn.  英雄， 勇士； 男主角， 男主人公
hers\tpron.  她的
can\tmodal verb. 能，会 n. 〔装食品或饮料的〕金属罐 v. 把…制成罐头
award\tv. 授予，给予；判给 n.  奖， 奖品； 报酬， 津贴
cap\tv.  覆盖； 笼罩 n. 帽子，便帽；盖，罩，套
organize\tv.  组织， 安排； 使有条理； 使有机化
car\tn.  汽车， 轿车； 车厢
ready\tadj.  准备好的， 现成的
marriage\tn.  结婚， 婚姻， 婚礼
cat\tn.  猫； 猫科动物
station\tv.  安置； 派驻， 驻扎 n. 站，台，局；身份，地位
disappointing\tadj.  令人失望的， 令人扫兴的
village\tn.  乡村， 村庄
player\tn.  选手， 队员； 做游戏的人； 演员； 演奏者； 播
nose\tv.  嗅出， 探出 n. 鼻子；鼻状物，前端突出部分
balloon\tn.  气球
cost\tn. 费用；成本 v. 价格为；需支付〔某一数量的钱〕
satisfy\tv.  满足， 满意； 确信， 信服
will\tmodal verb. 将，会，要〔用于构成将来时〕 n. 意志，毅力，决心 v. 设法用意志力驱使〔某事发生〕
match\tv.  和…相配， 和…相称 n. 比赛，竞赛；对手，敌手；匹配；火柴
smoke\tv.  冒烟， 冒气； 抽烟 n. 烟，烟尘；吸烟，抽烟
follow\tv. 跟随；接着；遵照，听从；听懂，领会 n.  跟随
