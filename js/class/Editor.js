define(["Reg", "ArticleType", "Article", "Utility"], function (
  Reg,
  ArticleType,
  Article,
  Utility
  ...
  class Editor {
    ...
    trimSpace() {
      this.content = this.content.replace(
        Reg.REMOVE.space[0].reg,
        Reg.REMOVE.space[0].replacement
      );
      this.setContent();
    }
    trimReturn() {
      this.content = this.content.replace(
        Reg.REMOVE.return[0].reg,
        Reg.REMOVE.return[0].replacement
      );
      this.setContent();
    }
